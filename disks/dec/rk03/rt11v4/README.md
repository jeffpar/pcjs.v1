...
permalink: /disks/dec/rk03/rt11v4/
---

RK03 RT-11 v4.0 Disk
--------------------

### Boot

To boot the RK03 "RT-11 v4.0" disk, start a [PDP-11/70](/devices/pdp11/machine/1170/panel/debugger/) with an
[RK11 Disk Controller](/devices/pdp11/rk11/), select the "RT-11 v4.0" disk from the list of disks
