...
x427:	ret				; 00000427  C3  '.'
	...
	adc	al,0x14			; 00000428  1414  '..'
	adc	al,0x10			; 0000042A  1410  '..'
	sub	ax,0x1414		; 0000042C  2D1414  '-..'
	add	[si],dl			; 0000042F  0014  '..'
	sub	ax,0x14			; 00000431  2D1400  '-..'
	adc	al,0x14			; 00000434  1414  '..'
	sub	ax,0x2d00		; 00000436  2D002D  '-.-'
	sub	ax,0x2d			; 00000439  2D2D00  '--.'
	add	al,0x12			; 0000043C  0412  '..'
	add	al,0x10			; 0000043E  0410  '..'
	push	ds			; 00000440  1E  '.'
	adc	al,[si]			; 00000441  1204  '..'
	add	[si],al			; 00000443  0004  '..'
	sub	ax,0x4			; 00000445  2D0400  '-..'
	add	al,0x16			; 00000448  0416  '..'
	adc	ax,0x0			; 0000044A  150000  '...'
	add	[bx+si],al		; 0000044D  0000  '..'
	adc	[si],al			; 0000044F  1004  '..'
	adc	al,[si]			; 00000451  1204  '..'
	adc	[bp+si],dl		; 00000453  1012  '..'
	adc	dl,[bp+si]		; 00000455  1212  '..'
	adc	[si],al			; 00000457  1004  '..'
	add	al,0x4			; 00000459  0404  '..'
	adc	[bx+si],dl		; 0000045B  1010  '..'
	add	al,0x4			; 0000045D  0404  '..'
	add	[si],al			; 0000045F  0004  '..'
	adc	[si],al			; 00000461  1004  '..'
	add	[si],al			; 00000463  0004  '..'
	add	al,0x10			; 00000465  0410  '..'
	add	[bx+si],dl		; 00000467  0010  '..'
	adc	[bx+si],dl		; 00000469  1010  '..'
	add	[bx+si-0x75],dl		; 0000046B  00508B  '.P.'
	push	ss			; 0000046E  16  '.'
	arpl	[si],ax			; 0000046F  6304  'c.'
...
x480:	in	al,dx			; 00000480  EC  '.'
	...
	jmp	short x492		; 00000490  EB00  '..'

x492:	mov	al,ah			; 00000492  8AC4  '..'
	out	dx,al			; 00000494  EE  '.'
	jmp	short x497		; 00000495  EB00  '..'

x497:	mov	al,bl			; 00000497  8AC3  '..'
...
x49e:	in	al,dx			; 0000049E  EC  '.'
	...
	jmp	short x4a7		; 000004A5  EB00  '..'

x4a7:	in	al,dx			; 000004A7  EC  '.'
	and	al,0x10			; 000004A8  2410  '$.'
	push	ax			; 000004AA  50  'P'
	mov	al,0x0			; 000004AB  B000  '..'
	mov	dx,0x3c8		; 000004AD  BAC803  '...'
	out	dx,al			; 000004B0  EE  '.'
	jmp	short x4b3		; 000004B1  EB00  '..'

x4b3:	mov	dx,0x3c9		; 000004B3  BAC903  '...'
	out	dx,al			; 000004B6  EE  '.'
	jmp	short x4b9		; 000004B7  EB00  '..'

x4b9:	out	dx,al			; 000004B9  EE  '.'
	jmp	short x4bc		; 000004BA  EB00  '..'

x4bc:	out	dx,al			; 000004BC  EE  '.'
	sti				; 000004BD  FB  '.'
...
x686:	mov	al,0xb6			; 00000686  B0B6  '..'
...
x127a:	mov	dx,0x3c4		; 0000127A  BAC403  '...'
	...
	add	[bx+si],ax		; 00001290  0100  '..'
	add	[bx+si],ax		; 00001292  0100  '..'
	add	[bx+si],ax		; 00001294  0100  '..'
	add	[bx+si],ax		; 00001296  0100  '..'
	add	al,[bx+si]		; 00001298  0200  '..'
	add	al,[bx+si]		; 0000129A  0200  '..'
	add	al,[bx+si]		; 0000129C  0200  '..'
	add	[bx+si],ax		; 0000129E  0100  '..'
	add	ax,[bx+si]		; 000012A0  0300  '..'

	times	4 dw 0x0000		; 000012A2 - 000012A8
	add	ax,[bx+si]		; 000012AA  0300  '..'
	add	ax,[bx+si]		; 000012AC  0300  '..'
	add	ax,[bx+si]		; 000012AE  0300  '..'
	add	ax,[bx+si]		; 000012B0  0300  '..'
	add	ax,[bx+si]		; 000012B2  0300  '..'
	add	ax,[bx+si]		; 000012B4  0300  '..'
	add	al,0x0			; 000012B6  0400  '..'
	rcl	byte [bp+si],0xe8	; 000012B8  C012E8  '...'
	adc	cl,[bp+si]		; 000012BB  120A  '.',0x0A
	adc	bx,[si]			; 000012BD  131C  '..'
	adc	ax,[bp+si+0x13]		; 000012BF  134213  '.B.'
	db	0x82			; 000012C2  82  '.'
	adc	ax,dx			; 000012C3  13C2  '..'
	adc	ax,[bp+si]		; 000012C5  1302  '..'
	adc	al,0x42			; 000012C7  1442  '.B'
	adc	al,0x82			; 000012C9  1482  '..'
	adc	al,0xc2			; 000012CB  14C2  '..'
	adc	al,0x0			; 000012CD  1400  '..'
	add	[bx+si],al		; 000012CF  0000  '..'
	add	[bp+si+0xc215],al	; 000012D1  008215C2  '....'
	adc	ax,0x1602		; 000012D5  150216  '...'
	inc	dx			; 000012D8  42  'B'
	push	ss			; 000012D9  16  '.'
	db	0x82			; 000012DA  82  '.'
	push	ss			; 000012DB  16  '.'
	ret	0x16			; 000012DC  C21600  '...'

	add	[bx+si],al		; 000012DF  0000  '..'
	add	[bx+si],al		; 000012E1  0000  '..'
	add	[bx+si],al		; 000012E3  0000  '..'
	add	[bp+si+0x1a],al		; 000012E5  00421A  '.B.'
	add	bl,[bx+si]		; 000012E8  0218  '..'
	inc	dx			; 000012EA  42  'B'
	sbb	[bp+si+0xc218],al	; 000012EB  188218C2  '....'
	sbb	[bx+si],al		; 000012EF  1800  '..'
	add	[bx+si],al		; 000012F1  0000  '..'
	add	[bx+si],al		; 000012F3  0000  '..'
	add	[bp+si],al		; 000012F5  0002  '..'
	adc	ax,0x0			; 000012F7  150000  '...'

	times	6 dw 0x0000		; 000012FA - 00001304
	db	0x82			; 00001306  82  '.'
	pop	ss			; 00001307  17  '.'
	ret	0x217			; 00001308  C21702  '...'

	sbb	[bp+si],ax		; 0000130B  1902  '..'
	sbb	[bp+si+0x19],ax		; 0000130D  194219  '.B.'
	inc	dx			; 00001310  42  'B'
	sbb	[bx+si],ax		; 00001311  1900  '..'
	add	[bx+si],al		; 00001313  0000  '..'
	add	[bx+si],al		; 00001315  0000  '..'
	add	[bp+si+0x4219],al	; 00001317  00821942  '...B'
	adc	ax,0x0			; 0000131B  150000  '...'

	times	16 dw 0x0000		; 0000131E - 0000133C
	ret	0x219			; 0000133E  C21902  '...'

	sbb	ch,[bx+si]		; 00001341  1A28  '.('
	sbb	[bx+si],cl		; 00001343  1808  '..'
	add	[bx+si],cl		; 00001345  0008  '..'
	or	[bp+di],ax		; 00001347  0903  '..'
	add	[bp+si],al		; 00001349  0002  '..'
	arpl	[di],bp			; 0000134B  632D  'c-'
	daa				; 0000134D  27  0x27
	sub	[bx+si+0xa02b],dl	; 0000134E  28902BA0  '(.+.'
	mov	di,0x1f			; 00001352  BF1F00  '...'
	mov	word [0x7],0x0		; 00001355  C70607000000  '......'
	add	[si+0x8f8e],bl		; 0000135B  009C8E8F  '....'
	adc	al,0x1f			; 0000135F  141F  '..'
	xchg	ax,si			; 00001361  96  '.'
	mov	cx,0xffa3		; 00001362  B9A3FF  '...'
	add	[bx+di],al		; 00001365  0001  '..'
	add	al,[bp+di]		; 00001367  0203  '..'
	add	al,0x5			; 00001369  0405  '..'
	push	es			; 0000136B  06  '.'
	pop	es			; 0000136C  07  '.'
	adc	[bx+di],dl		; 0000136D  1011  '..'
	adc	dl,[bp+di]		; 0000136F  1213  '..'
	adc	al,0x15			; 00001371  1415  '..'
	push	ss			; 00001373  16  '.'
	pop	ss			; 00001374  17  '.'
	or	[bx+si],al		; 00001375  0800  '..'
	sldt	[bx+si]			; 00001377  0F0000  '...'
	add	[bx+si],al		; 0000137A  0000  '..'
	add	[bx+si],al		; 0000137C  0000  '..'
	adc	[0xff00],cl		; 0000137E  100E00FF  '....'
	sub	[bx+si],bl		; 00001382  2818  '(.'
	or	[bx+si],al		; 00001384  0800  '..'
	or	[bx+di],cl		; 00001386  0809  '..'
	add	ax,[bx+si]		; 00001388  0300  '..'
	add	ah,[bp+di+0x2d]		; 0000138A  02632D  '.c-'
	daa				; 0000138D  27  0x27
	sub	[bx+si+0xa02b],dl	; 0000138E  28902BA0  '(.+.'
	mov	di,0x1f			; 00001392  BF1F00  '...'
	mov	word [0x7],0x0		; 00001395  C70607000000  '......'
	add	[si+0x8f8e],bl		; 0000139B  009C8E8F  '....'
	adc	al,0x1f			; 0000139F  141F  '..'
	xchg	ax,si			; 000013A1  96  '.'
	mov	cx,0xffa3		; 000013A2  B9A3FF  '...'
	add	[bx+di],al		; 000013A5  0001  '..'
	add	al,[bp+di]		; 000013A7  0203  '..'
	add	al,0x5			; 000013A9  0405  '..'
	push	es			; 000013AB  06  '.'
	pop	es			; 000013AC  07  '.'
	adc	[bx+di],dl		; 000013AD  1011  '..'
	adc	dl,[bp+di]		; 000013AF  1213  '..'
	adc	al,0x15			; 000013B1  1415  '..'
	push	ss			; 000013B3  16  '.'
	pop	ss			; 000013B4  17  '.'
	or	[bx+si],al		; 000013B5  0800  '..'
	sldt	[bx+si]			; 000013B7  0F0000  '...'
	add	[bx+si],al		; 000013BA  0000  '..'
	add	[bx+si],al		; 000013BC  0000  '..'
	adc	[0xff00],cl		; 000013BE  100E00FF  '....'
	push	ax			; 000013C2  50  'P'
	sbb	[bx+si],cl		; 000013C3  1808  '..'
	add	[bx+si],dl		; 000013C5  0010  '..'
	add	[bp+di],ax		; 000013C7  0103  '..'
	add	[bp+si],al		; 000013C9  0002  '..'
	arpl	[bx+0x4f],bx		; 000013CB  635F4F  'c_O'
	push	ax			; 000013CE  50  'P'
	db	0x82			; 000013CF  82  '.'
	push	bp			; 000013D0  55  'U'
	cmp	word [bx+0x1f],0x6c7	; 000013D1  81BF1F00C706  '......'
	pop	es			; 000013D7  07  '.'
	add	[bx+si],al		; 000013D8  0000  '..'
	add	[bx+si],al		; 000013DA  0000  '..'
	pushf				; 000013DC  9C  '.'
	mov	cs,[bx+0x1f28]		; 000013DD  8E8F281F  '..(.'
	xchg	ax,si			; 000013E1  96  '.'
	mov	cx,0xffa3		; 000013E2  B9A3FF  '...'
	add	[bx+di],al		; 000013E5  0001  '..'
	add	al,[bp+di]		; 000013E7  0203  '..'
	add	al,0x5			; 000013E9  0405  '..'
	push	es			; 000013EB  06  '.'
	pop	es			; 000013EC  07  '.'
	adc	[bx+di],dl		; 000013ED  1011  '..'
	adc	dl,[bp+di]		; 000013EF  1213  '..'
	adc	al,0x15			; 000013F1  1415  '..'
	push	ss			; 000013F3  16  '.'
	pop	ss			; 000013F4  17  '.'
	or	[bx+si],al		; 000013F5  0800  '..'
	sldt	[bx+si]			; 000013F7  0F0000  '...'
	add	[bx+si],al		; 000013FA  0000  '..'
	add	[bx+si],al		; 000013FC  0000  '..'
	adc	[0xff00],cl		; 000013FE  100E00FF  '....'
	push	ax			; 00001402  50  'P'
	sbb	[bx+si],cl		; 00001403  1808  '..'
	add	[bx+si],dl		; 00001405  0010  '..'
	add	[bp+di],ax		; 00001407  0103  '..'
	add	[bp+si],al		; 00001409  0002  '..'
	arpl	[bx+0x4f],bx		; 0000140B  635F4F  'c_O'
	push	ax			; 0000140E  50  'P'
	db	0x82			; 0000140F  82  '.'
	push	bp			; 00001410  55  'U'
	cmp	word [bx+0x1f],0x6c7	; 00001411  81BF1F00C706  '......'
	pop	es			; 00001417  07  '.'
	add	[bx+si],al		; 00001418  0000  '..'
	add	[bx+si],al		; 0000141A  0000  '..'
	pushf				; 0000141C  9C  '.'
	mov	cs,[bx+0x1f28]		; 0000141D  8E8F281F  '..(.'
	xchg	ax,si			; 00001421  96  '.'
	mov	cx,0xffa3		; 00001422  B9A3FF  '...'
	add	[bx+di],al		; 00001425  0001  '..'
	add	al,[bp+di]		; 00001427  0203  '..'
	add	al,0x5			; 00001429  0405  '..'
	push	es			; 0000142B  06  '.'
	pop	es			; 0000142C  07  '.'
	adc	[bx+di],dl		; 0000142D  1011  '..'
	adc	dl,[bp+di]		; 0000142F  1213  '..'
	adc	al,0x15			; 00001431  1415  '..'
	push	ss			; 00001433  16  '.'
	pop	ss			; 00001434  17  '.'
	or	[bx+si],al		; 00001435  0800  '..'
	sldt	[bx+si]			; 00001437  0F0000  '...'
	add	[bx+si],al		; 0000143A  0000  '..'
	add	[bx+si],al		; 0000143C  0000  '..'
	adc	[0xff00],cl		; 0000143E  100E00FF  '....'
	sub	[bx+si],bl		; 00001442  2818  '(.'
	or	[bx+si],al		; 00001444  0800  '..'
	inc	ax			; 00001446  40  '@'
	or	[bp+di],ax		; 00001447  0903  '..'
	add	[bp+si],al		; 00001449  0002  '..'
	arpl	[di],bp			; 0000144B  632D  'c-'
	daa				; 0000144D  27  0x27
	sub	[bx+si+0x802b],dl	; 0000144E  28902B80  '(.+.'
	mov	di,0x1f			; 00001452  BF1F00  '...'
	rol	word [bx+si],0x0	; 00001455  C10000  '...'
	add	[bx+si],al		; 00001458  0000  '..'
	add	[bx+si],al		; 0000145A  0000  '..'
	pushf				; 0000145C  9C  '.'
	mov	cs,[bx+0x14]		; 0000145D  8E8F1400  '....'
	xchg	ax,si			; 00001461  96  '.'
	mov	cx,0xffa2		; 00001462  B9A2FF  '...'
	add	[bp+di],dl		; 00001465  0013  '..'
	adc	ax,0x217		; 00001467  151702  '...'
	add	al,0x6			; 0000146A  0406  '..'
	pop	es			; 0000146C  07  '.'
	adc	[bx+di],dl		; 0000146D  1011  '..'
	adc	dl,[bp+di]		; 0000146F  1213  '..'
	adc	al,0x15			; 00001471  1415  '..'
	push	ss			; 00001473  16  '.'
	pop	ss			; 00001474  17  '.'
	add	[bx+si],ax		; 00001475  0100  '..'
	add	ax,[bx+si]		; 00001477  0300  '..'
	add	[bx+si],al		; 00001479  0000  '..'
	add	[bx+si],al		; 0000147B  0000  '..'
	add	[bx+si],dh		; 0000147D  0030  '.0'
	db	0x0F			; 0000147F  0F  '.'
	add	bh,bh			; 00001480  00FF  '..'
	sub	[bx+si],bl		; 00001482  2818  '(.'
	or	[bx+si],al		; 00001484  0800  '..'
	inc	ax			; 00001486  40  '@'
	or	[bp+di],ax		; 00001487  0903  '..'
	add	[bp+si],al		; 00001489  0002  '..'
	arpl	[di],bp			; 0000148B  632D  'c-'
	daa				; 0000148D  27  0x27
	sub	[bx+si+0x802b],dl	; 0000148E  28902B80  '(.+.'
	mov	di,0x1f			; 00001492  BF1F00  '...'
	rol	word [bx+si],0x0	; 00001495  C10000  '...'
	add	[bx+si],al		; 00001498  0000  '..'
	add	[bx+si],al		; 0000149A  0000  '..'
	pushf				; 0000149C  9C  '.'
	mov	cs,[bx+0x14]		; 0000149D  8E8F1400  '....'
	xchg	ax,si			; 000014A1  96  '.'
	mov	cx,0xffa2		; 000014A2  B9A2FF  '...'
	add	[bp+di],dl		; 000014A5  0013  '..'
	adc	ax,0x217		; 000014A7  151702  '...'
	add	al,0x6			; 000014AA  0406  '..'
	pop	es			; 000014AC  07  '.'
	adc	[bx+di],dl		; 000014AD  1011  '..'
	adc	dl,[bp+di]		; 000014AF  1213  '..'
	adc	al,0x15			; 000014B1  1415  '..'
	push	ss			; 000014B3  16  '.'
	pop	ss			; 000014B4  17  '.'
	add	[bx+si],ax		; 000014B5  0100  '..'
	add	ax,[bx+si]		; 000014B7  0300  '..'
	add	[bx+si],al		; 000014B9  0000  '..'
	add	[bx+si],al		; 000014BB  0000  '..'
	add	[bx+si],dh		; 000014BD  0030  '.0'
	db	0x0F			; 000014BF  0F  '.'
	add	bh,bh			; 000014C0  00FF  '..'
	push	ax			; 000014C2  50  'P'
	sbb	[bx+si],cl		; 000014C3  1808  '..'
	add	[bx+si+0x1],al		; 000014C5  004001  '.@.'
	add	[bx+si],ax		; 000014C8  0100  '..'
	push	es			; 000014CA  06  '.'
	arpl	[bx+0x4f],bx		; 000014CB  635F4F  'c_O'
	push	ax			; 000014CE  50  'P'
	db	0x82			; 000014CF  82  '.'
	push	sp			; 000014D0  54  'T'
	cmp	byte [bx+0x1f],0xc1	; 000014D1  80BF1F00C1  '.....'
	add	[bx+si],al		; 000014D6  0000  '..'
	add	[bx+si],al		; 000014D8  0000  '..'
	add	[bx+si],al		; 000014DA  0000  '..'
	pushf				; 000014DC  9C  '.'
	mov	cs,[bx+0x28]		; 000014DD  8E8F2800  '..(.'
	xchg	ax,si			; 000014E1  96  '.'
	mov	cx,0xffc2		; 000014E2  B9C2FF  '...'
	add	[bx],dl			; 000014E5  0017  '..'
	pop	ss			; 000014E7  17  '.'
	pop	ss			; 000014E8  17  '.'
	pop	ss			; 000014E9  17  '.'
	pop	ss			; 000014EA  17  '.'
	...
	pop	ss			; 000014F3  17  '.'
	pop	ss			; 000014F4  17  '.'
	add	[bx+si],ax		; 000014F5  0100  '..'
	add	[bx+si],ax		; 000014F7  0100  '..'
	add	[bx+si],al		; 000014F9  0000  '..'
	add	[bx+si],al		; 000014FB  0000  '..'
	add	[bx+si],al		; 000014FD  0000  '..'
	or	ax,0xff00		; 000014FF  0D00FF  0x0D,'..'
	push	ax			; 00001502  50  'P'
	sbb	[0x1000],cl		; 00001503  180E0010  '....'
	add	[bp+di],al		; 00001507  0003  '..'
	add	[bp+di],al		; 00001509  0003  '..'
	cmpsb				; 0000150B  A6  '.'
	pop	di			; 0000150C  5F  '_'
	dec	di			; 0000150D  4F  'O'
	push	ax			; 0000150E  50  'P'
	db	0x82			; 0000150F  82  '.'
	push	bp			; 00001510  55  'U'
	cmp	word [bx+0x1f],0xb4d	; 00001511  81BF1F004D0B  '....M.'
	or	al,0x0			; 00001517  0C00  '..'
	add	[bx+si],al		; 00001519  0000  '..'
	add	[bp+di+0x5d85],al	; 0000151B  0083855D  '...]'
	sub	[di],cl			; 0000151F  280D  '(',0x0D
	arpl	[bp+si+0xffa3],di	; 00001521  63BAA3FF  'c...'
	add	[bx+si],cl		; 00001525  0008  '..'
	or	[bx+si],cl		; 00001527  0808  '..'
	or	[bx+si],cl		; 00001529  0808  '..'
	or	[bx+si],cl		; 0000152B  0808  '..'
	adc	[bx+si],bl		; 0000152D  1018  '..'
	sbb	[bx+si],bl		; 0000152F  1818  '..'
	sbb	[bx+si],bl		; 00001531  1818  '..'
	sbb	[bx+si],bl		; 00001533  1818  '..'
	push	cs			; 00001535  0E  '.'
	add	[bx],cl			; 00001536  000F  '..'
	or	[bx+si],al		; 00001538  0800  '..'
	add	[bx+si],al		; 0000153A  0000  '..'
	add	[bx+si],al		; 0000153C  0000  '..'
	adc	[bp+si],cl		; 0000153E  100A  '.',0x0A
	add	bh,bh			; 00001540  00FF  '..'
	push	ax			; 00001542  50  'P'
	sbb	[bx+si],dl		; 00001543  1810  '..'
	add	[di+0x21],bh		; 00001545  007D21  '.}!'
	sldt	[0x5f63]		; 00001548  0F0006635F  '...c_'
	dec	di			; 0000154D  4F  'O'
	push	ax			; 0000154E  50  'P'
	db	0x82			; 0000154F  82  '.'
	push	bp			; 00001550  55  'U'
	cmp	word [bx+0x1f],0x40	; 00001551  81BF1F004000  '....@.'
	add	[bx+si],al		; 00001557  0000  '..'
	add	[bx+si],al		; 00001559  0000  '..'
	add	[si+0x8f8e],bl		; 0000155B  009C8E8F  '....'
	sub	[bx],bl			; 0000155F  281F  '(.'
	xchg	ax,si			; 00001561  96  '.'
	mov	cx,0xffe3		; 00001562  B9E3FF  '...'
	add	[bx+di],al		; 00001565  0001  '..'
	add	al,[bp+di]		; 00001567  0203  '..'
	add	al,0x5			; 00001569  0405  '..'
	adc	al,0x7			; 0000156B  1407  '..'
	db	'89:;<=>?'
	add	[bx+si],ax		; 00001575  0100  '..'
	sldt	[bx+si]			; 00001577  0F0000  '...'
	add	[bx+si],al		; 0000157A  0000  '..'
	add	[bx+si],al		; 0000157C  0000  '..'
	add	[di],al			; 0000157E  0005  '..'
	ud0				; 00001580  0FFF  '..'

	times	32 dw 0x0000		; 00001582 - 000015C0
	sub	[bx+si],bl		; 000015C2  2818  '(.'
	or	[bx+si],al		; 000015C4  0800  '..'
	inc	ax			; 000015C6  40  '@'
	add	[bx+si],al		; 000015C7  0000  '..'
	add	[bp+di],al		; 000015C9  0003  '..'
	and	si,[bx]			; 000015CB  2337  '#7'
	daa				; 000015CD  27  0x27
	sub	ax,0x3137		; 000015CE  2D3731  '-71'
	adc	ax,0x1104		; 000015D1  150411  '...'
	add	[bx+0x6],al		; 000015D4  004706  '.G.'
	pop	es			; 000015D7  07  '.'
	add	[bx+si],al		; 000015D8  0000  '..'
	add	[bx+si],al		; 000015DA  0000  '..'
	loope	x1602			; 000015DC  E124  '.$'
	db	0xC7			; 000015DE  C7  '.'
	adc	al,0x8			; 000015DF  1408  '..'
	db	0xE0,0xF0
	mov	[0xff],ax		; 000015E3  A3FF00  '...'
	add	[bp+si],ax		; 000015E6  0102  '..'
	add	ax,[si]			; 000015E8  0304  '..'
	add	ax,0x706		; 000015EA  050607  '...'
	adc	[bx+di],dl		; 000015ED  1011  '..'
	adc	dl,[bp+di]		; 000015EF  1213  '..'
	adc	al,0x15			; 000015F1  1415  '..'
	push	ss			; 000015F3  16  '.'
	pop	ss			; 000015F4  17  '.'
	or	[bx+si],al		; 000015F5  0800  '..'
	sldt	[bx+si]			; 000015F7  0F0000  '...'
	add	[bx+si],al		; 000015FA  0000  '..'
	add	[bx+si],al		; 000015FC  0000  '..'
	adc	[0xff00],cl		; 000015FE  100E00FF  '....'
x1602:	push	ax			; 00001602  50  'P'
	add	[bx+si],al		; 00001603  0000  '..'
	add	[bx+si],al		; 00001605  0000  '..'
	sub	[bx],cx			; 00001607  290F  ').'
	add	[0x5f62],al		; 00001609  0006625F  '..b_'
	dec	di			; 0000160D  4F  'O'
	push	ax			; 0000160E  50  'P'
	db	0x82			; 0000160F  82  '.'
	push	bp			; 00001610  55  'U'
	cmp	word [bx+0x1f],0x40	; 00001611  81BF1F004000  '....@.'
	add	[bx+si],al		; 00001617  0000  '..'
	add	[bx+si],al		; 00001619  0000  '..'
	add	[si+0x8f8e],bl		; 0000161B  009C8E8F  '....'
	sub	[bx],bl			; 0000161F  281F  '(.'
	xchg	ax,si			; 00001621  96  '.'
	mov	cx,0xffe3		; 00001622  B9E3FF  '...'

	times	7 dw 0x0000		; 00001625 - 00001631
	add	[bx],bh			; 00001633  003F  '.?'
	add	[bx+si],ax		; 00001635  0100  '..'
	sldt	[bx+si]			; 00001637  0F0000  '...'
	add	[bx],cl			; 0000163A  000F  '..'
	add	[bx+si],al		; 0000163C  0000  '..'
	or	[di],al			; 0000163E  0805  '..'
	ud0				; 00001640  0FFF  '..'
	push	ax			; 00001642  50  'P'
	add	[bx+si],al		; 00001643  0000  '..'
	add	[bx+si],al		; 00001645  0000  '..'
	sub	[bx],cx			; 00001647  290F  ').'
	add	[0x5f63],al		; 00001649  0006635F  '..c_'
	dec	di			; 0000164D  4F  'O'
	push	ax			; 0000164E  50  'P'
	db	0x82			; 0000164F  82  '.'
	push	bp			; 00001650  55  'U'
	cmp	word [bx+0x1f],0x40	; 00001651  81BF1F004000  '....@.'
	add	[bx+si],al		; 00001657  0000  '..'
	add	[bx+si],al		; 00001659  0000  '..'
	add	[si+0x8f8e],bl		; 0000165B  009C8E8F  '....'
	sub	[bx],bl			; 0000165F  281F  '(.'
	xchg	ax,si			; 00001661  96  '.'
	mov	cx,0xffe3		; 00001662  B9E3FF  '...'

	times	7 dw 0x0000		; 00001665 - 00001671
	add	[bx],bh			; 00001673  003F  '.?'
	add	[bx+si],ax		; 00001675  0100  '..'
	sldt	[bx+si]			; 00001677  0F0000  '...'
	add	[bx],cl			; 0000167A  000F  '..'
	add	[bx+si],al		; 0000167C  0000  '..'
	or	[di],al			; 0000167E  0805  '..'
	ud0				; 00001680  0FFF  '..'
	sub	[bx+si],bl		; 00001682  2818  '(.'
	or	[bx+si],al		; 00001684  0800  '..'
	and	[bx+di],cl		; 00001686  2009  ' .'
	sldt	[0x2d63]		; 00001688  0F0006632D  '...c-'
	daa				; 0000168D  27  0x27
	sub	[bx+si+0x802b],dl	; 0000168E  28902B80  '(.+.'
	mov	di,0x1f			; 00001692  BF1F00  '...'
	rol	byte [bx+si],0x0	; 00001695  C00000  '...'
	add	[bx+si],al		; 00001698  0000  '..'
	add	[bx+si],al		; 0000169A  0000  '..'
	pushf				; 0000169C  9C  '.'
	mov	cs,[bx+0x14]		; 0000169D  8E8F1400  '....'
	xchg	ax,si			; 000016A1  96  '.'
	mov	cx,0xffe3		; 000016A2  B9E3FF  '...'
	add	[bx+di],al		; 000016A5  0001  '..'
	add	al,[bp+di]		; 000016A7  0203  '..'
	add	al,0x5			; 000016A9  0405  '..'
	push	es			; 000016AB  06  '.'
	pop	es			; 000016AC  07  '.'
	adc	[bx+di],dl		; 000016AD  1011  '..'
	adc	dl,[bp+di]		; 000016AF  1213  '..'
	adc	al,0x15			; 000016B1  1415  '..'
	push	ss			; 000016B3  16  '.'
	pop	ss			; 000016B4  17  '.'
	add	[bx+si],ax		; 000016B5  0100  '..'
	sldt	[bx+si]			; 000016B7  0F0000  '...'
	add	[bx+si],al		; 000016BA  0000  '..'
	add	[bx+si],al		; 000016BC  0000  '..'
	add	[di],al			; 000016BE  0005  '..'
	ud0				; 000016C0  0FFF  '..'
	push	ax			; 000016C2  50  'P'
	sbb	[bx+si],cl		; 000016C3  1808  '..'
	add	[bx+si+0x1],al		; 000016C5  004001  '.@.'
	sldt	[0x5f63]		; 000016C8  0F0006635F  '...c_'
	dec	di			; 000016CD  4F  'O'
	push	ax			; 000016CE  50  'P'
	db	0x82			; 000016CF  82  '.'
	push	sp			; 000016D0  54  'T'
	cmp	byte [bx+0x1f],0xc0	; 000016D1  80BF1F00C0  '.....'
	add	[bx+si],al		; 000016D6  0000  '..'
	add	[bx+si],al		; 000016D8  0000  '..'
	add	[bx+si],al		; 000016DA  0000  '..'
	pushf				; 000016DC  9C  '.'
	mov	cs,[bx+0x28]		; 000016DD  8E8F2800  '..(.'
	xchg	ax,si			; 000016E1  96  '.'
	mov	cx,0xffe3		; 000016E2  B9E3FF  '...'
	add	[bx+di],al		; 000016E5  0001  '..'
	add	al,[bp+di]		; 000016E7  0203  '..'
	add	al,0x5			; 000016E9  0405  '..'
	push	es			; 000016EB  06  '.'
	pop	es			; 000016EC  07  '.'
	adc	[bx+di],dl		; 000016ED  1011  '..'
	adc	dl,[bp+di]		; 000016EF  1213  '..'
	adc	al,0x15			; 000016F1  1415  '..'
	push	ss			; 000016F3  16  '.'
	pop	ss			; 000016F4  17  '.'
	add	[bx+si],ax		; 000016F5  0100  '..'
	sldt	[bx+si]			; 000016F7  0F0000  '...'
	add	[bx+si],al		; 000016FA  0000  '..'
	add	[bx+si],al		; 000016FC  0000  '..'
	add	[di],al			; 000016FE  0005  '..'
	ud0				; 00001700  0FFF  '..'
	push	ax			; 00001702  50  'P'
	sbb	[0x8000],cl		; 00001703  180E0080  '....'
	add	ax,0xf			; 00001707  050F00  '...'
	add	[bp+si+0x4f60],ah	; 0000170A  00A2604F  '..`O'
	push	si			; 0000170E  56  'V'
	sbb	dl,[bx+si-0x20]		; 0000170F  1A50E0  '.P.'
	jo	x1733			; 00001712  701F  'p.'

	times	4 dw 0x0000		; 00001714 - 0000171A
	pop	si			; 0000171C  5E  '^'
	cs	pop bp			; 0000171D  2E5D  '.]'
	adc	al,0x0			; 0000171F  1400  '..'
	pop	si			; 00001721  5E  '^'
	outsb				; 00001722  6E  'n'
	mov	di,di			; 00001723  8BFF  '..'
	add	[bx+si],cl		; 00001725  0008  '..'
	add	[bx+si],al		; 00001727  0000  '..'
	sbb	[bx+si],bl		; 00001729  1818  '..'
	add	[bx+si],al		; 0000172B  0000  '..'
	add	[bx+si],cl		; 0000172D  0008  '..'
	add	[bx+si],al		; 0000172F  0000  '..'
	add	[bx+si],bl		; 00001731  0018  '..'
x1733:	add	[bx+si],al		; 00001733  0000  '..'
	or	ax,[bx+si]		; 00001735  0B00  '..'
	add	ax,0x0			; 00001737  050000  '...'
	add	[bx+si],al		; 0000173A  0000  '..'
	add	[bx+si],al		; 0000173C  0000  '..'
	adc	[bx],al			; 0000173E  1007  '..'
	ud0				; 00001740  0FFF  '..'
	push	ax			; 00001742  50  'P'
	sbb	[0x8000],cl		; 00001743  180E0080  '....'
	add	ax,0xf			; 00001747  050F00  '...'
	add	[bx+0x4f5b],ah		; 0000174A  00A75B4F  '..[O'
	push	bx			; 0000174E  53  'S'
	pop	ss			; 0000174F  17  '.'
	push	ax			; 00001750  50  'P'
	mov	dx,0x1f6c		; 00001751  BA6C1F  '.l.'

	times	4 dw 0x0000		; 00001754 - 0000175A
	pop	si			; 0000175C  5E  '^'
	sub	bx,[di+0x14]		; 0000175D  2B5D14  '+].'
	maxps	xmm1,[bp+si]		; 00001760  0F5F0A  '._',0x0A
	mov	di,di			; 00001763  8BFF  '..'
	add	[bx+di],al		; 00001765  0001  '..'
	add	[bx+si],al		; 00001767  0000  '..'
	add	al,0x7			; 00001769  0407  '..'
	add	[bx+si],al		; 0000176B  0000  '..'
	add	[bx+di],al		; 0000176D  0001  '..'
	add	[bx+si],al		; 0000176F  0000  '..'
	add	al,0x7			; 00001771  0407  '..'
	add	[bx+si],al		; 00001773  0000  '..'
	add	[bx+si],ax		; 00001775  0100  '..'
	add	ax,0x0			; 00001777  050000  '...'
	add	[bx+si],al		; 0000177A  0000  '..'
	add	[bx+si],al		; 0000177C  0000  '..'
	adc	[bx],al			; 0000177E  1007  '..'
	ud0				; 00001780  0FFF  '..'
	push	ax			; 00001782  50  'P'
	sbb	[0x8000],cl		; 00001783  180E0080  '....'
	add	[bx],cx			; 00001787  010F  '..'
	add	[0x5fa2],al		; 00001789  0006A25F  '..._'
	dec	di			; 0000178D  4F  'O'
	push	ax			; 0000178E  50  'P'
	db	0x82			; 0000178F  82  '.'
	push	sp			; 00001790  54  'T'
	cmp	byte [bx+0x1f],0x40	; 00001791  80BF1F0040  '....@'
	add	[bx+si],al		; 00001796  0000  '..'
	add	[bx+si],al		; 00001798  0000  '..'
	add	[bx+si],al		; 0000179A  0000  '..'
	add	word [di+0x285d],byte +0xf; 0000179C  83855D280F  '..](.'
	arpl	[bp+si+0xffe3],di	; 000017A1  63BAE3FF  'c...'
	add	[bx+si],cl		; 000017A5  0008  '..'
	add	[bx+si],al		; 000017A7  0000  '..'
	sbb	[bx+si],bl		; 000017A9  1818  '..'
	add	[bx+si],al		; 000017AB  0000  '..'
	add	[bx+si],cl		; 000017AD  0008  '..'
	add	[bx+si],al		; 000017AF  0000  '..'
	add	[bx+si],bl		; 000017B1  0018  '..'
	add	[bx+si],al		; 000017B3  0000  '..'
	or	ax,[bx+si]		; 000017B5  0B00  '..'
	add	ax,0x0			; 000017B7  050000  '...'
	add	[bx+si],al		; 000017BA  0000  '..'
	add	[bx+si],al		; 000017BC  0000  '..'
	add	[di],al			; 000017BE  0005  '..'
	add	ax,0x50ff		; 000017C0  05FF50  '..P'
	sbb	[0x8000],cl		; 000017C3  180E0080  '....'
	add	[bx],cx			; 000017C7  010F  '..'
	add	[0x5fa3],al		; 000017C9  0006A35F  '..._'
	dec	di			; 000017CD  4F  'O'
	push	ax			; 000017CE  50  'P'
	db	0x82			; 000017CF  82  '.'
	push	sp			; 000017D0  54  'T'
	cmp	byte [bx+0x1f],0x40	; 000017D1  80BF1F0040  '....@'
	add	[bx+si],al		; 000017D6  0000  '..'
	add	[bx+si],al		; 000017D8  0000  '..'
	add	[bx+si],al		; 000017DA  0000  '..'
	add	word [di+0x285d],byte +0xf; 000017DC  83855D280F  '..](.'
	arpl	[bp+si+0xffe3],di	; 000017E1  63BAE3FF  'c...'
	add	[bx+di],al		; 000017E5  0001  '..'
	add	al,[bp+di]		; 000017E7  0203  '..'
	add	al,0x5			; 000017E9  0405  '..'
	adc	al,0x7			; 000017EB  1407  '..'
	db	'89:;<=>?'
	add	[bx+si],ax		; 000017F5  0100  '..'
	sldt	[bx+si]			; 000017F7  0F0000  '...'
	add	[bx+si],al		; 000017FA  0000  '..'
	add	[bx+si],al		; 000017FC  0000  '..'
	add	[di],al			; 000017FE  0005  '..'
	ud0				; 00001800  0FFF  '..'
	sub	[bx+si],bl		; 00001802  2818  '(.'
	push	cs			; 00001804  0E  '.'
	add	[bx+si],cl		; 00001805  0008  '..'
	or	[bp+di],ax		; 00001807  0903  '..'
	add	[bp+si],al		; 00001809  0002  '..'
	mov	[0x272d],ax		; 0000180B  A32D27  '.-',0x27
	sub	[bx+si+0xa02b],dl	; 0000180E  28902BA0  '(.+.'
	mov	di,0x1f			; 00001812  BF1F00  '...'
	dec	bp			; 00001815  4D  'M'
	or	cx,[si]			; 00001816  0B0C  '..'
	add	[bx+si],al		; 00001818  0000  '..'
	add	[bx+si],al		; 0000181A  0000  '..'
	add	word [di+0x145d],byte +0x1f; 0000181C  83855D141F  '..]..'
	arpl	[bp+si+0xffa3],di	; 00001821  63BAA3FF  'c...'
	add	[bx+di],al		; 00001825  0001  '..'
	add	al,[bp+di]		; 00001827  0203  '..'
	add	al,0x5			; 00001829  0405  '..'
	adc	al,0x7			; 0000182B  1407  '..'
	db	'89:;<=>?'
	or	[bx+si],al		; 00001835  0800  '..'
	sldt	[bx+si]			; 00001837  0F0000  '...'
	add	[bx+si],al		; 0000183A  0000  '..'
	add	[bx+si],al		; 0000183C  0000  '..'
	adc	[0xff00],cl		; 0000183E  100E00FF  '....'
	sub	[bx+si],bl		; 00001842  2818  '(.'
	push	cs			; 00001844  0E  '.'
	add	[bx+si],cl		; 00001845  0008  '..'
	or	[bp+di],ax		; 00001847  0903  '..'
	add	[bp+si],al		; 00001849  0002  '..'
	mov	[0x272d],ax		; 0000184B  A32D27  '.-',0x27
	sub	[bx+si+0xa02b],dl	; 0000184E  28902BA0  '(.+.'
	mov	di,0x1f			; 00001852  BF1F00  '...'
	dec	bp			; 00001855  4D  'M'
	or	cx,[si]			; 00001856  0B0C  '..'
	add	[bx+si],al		; 00001858  0000  '..'
	add	[bx+si],al		; 0000185A  0000  '..'
	add	word [di+0x145d],byte +0x1f; 0000185C  83855D141F  '..]..'
	arpl	[bp+si+0xffa3],di	; 00001861  63BAA3FF  'c...'
	add	[bx+di],al		; 00001865  0001  '..'
	add	al,[bp+di]		; 00001867  0203  '..'
	add	al,0x5			; 00001869  0405  '..'
	adc	al,0x7			; 0000186B  1407  '..'
	db	'89:;<=>?'
	or	[bx+si],al		; 00001875  0800  '..'
	sldt	[bx+si]			; 00001877  0F0000  '...'
	add	[bx+si],al		; 0000187A  0000  '..'
	add	[bx+si],al		; 0000187C  0000  '..'
	adc	[0xff00],cl		; 0000187E  100E00FF  '....'
	push	ax			; 00001882  50  'P'
	sbb	[0x1000],cl		; 00001883  180E0010  '....'
	add	[bp+di],ax		; 00001887  0103  '..'
	add	[bp+si],al		; 00001889  0002  '..'
	mov	[0x4f5f],ax		; 0000188B  A35F4F  '._O'
	push	ax			; 0000188E  50  'P'
	db	0x82			; 0000188F  82  '.'
	push	bp			; 00001890  55  'U'
	cmp	word [bx+0x1f],0xb4d	; 00001891  81BF1F004D0B  '....M.'
	or	al,0x0			; 00001897  0C00  '..'
	add	[bx+si],al		; 00001899  0000  '..'
	add	[bp+di+0x5d85],al	; 0000189B  0083855D  '...]'
	sub	[bx],bl			; 0000189F  281F  '(.'
	arpl	[bp+si+0xffa3],di	; 000018A1  63BAA3FF  'c...'
	add	[bx+di],al		; 000018A5  0001  '..'
	add	al,[bp+di]		; 000018A7  0203  '..'
	add	al,0x5			; 000018A9  0405  '..'
	adc	al,0x7			; 000018AB  1407  '..'
	db	'89:;<=>?'
	or	[bx+si],al		; 000018B5  0800  '..'
	sldt	[bx+si]			; 000018B7  0F0000  '...'
	add	[bx+si],al		; 000018BA  0000  '..'
	add	[bx+si],al		; 000018BC  0000  '..'
	adc	[0xff00],cl		; 000018BE  100E00FF  '....'
	push	ax			; 000018C2  50  'P'
	sbb	[0x1000],cl		; 000018C3  180E0010  '....'
	add	[bp+di],ax		; 000018C7  0103  '..'
	add	[bp+si],al		; 000018C9  0002  '..'
	mov	[0x4f5f],ax		; 000018CB  A35F4F  '._O'
	push	ax			; 000018CE  50  'P'
	db	0x82			; 000018CF  82  '.'
	push	bp			; 000018D0  55  'U'
	cmp	word [bx+0x1f],0xb4d	; 000018D1  81BF1F004D0B  '....M.'
	or	al,0x0			; 000018D7  0C00  '..'
	add	[bx+si],al		; 000018D9  0000  '..'
	add	[bp+di+0x5d85],al	; 000018DB  0083855D  '...]'
	sub	[bx],bl			; 000018DF  281F  '(.'
	arpl	[bp+si+0xffa3],di	; 000018E1  63BAA3FF  'c...'
	add	[bx+di],al		; 000018E5  0001  '..'
	add	al,[bp+di]		; 000018E7  0203  '..'
	add	al,0x5			; 000018E9  0405  '..'
	adc	al,0x7			; 000018EB  1407  '..'
	db	'89:;<=>?'
	or	[bx+si],al		; 000018F5  0800  '..'
	sldt	[bx+si]			; 000018F7  0F0000  '...'
	add	[bx+si],al		; 000018FA  0000  '..'
	add	[bx+si],al		; 000018FC  0000  '..'
	adc	[0xff00],cl		; 000018FE  100E00FF  '....'
	sub	[bx+si],bl		; 00001902  2818  '(.'
	adc	[bx+si],al		; 00001904  1000  '..'
	or	[bx+si],cl		; 00001906  0808  '..'
	add	ax,[bx+si]		; 00001908  0300  '..'
	add	ah,[bx+0x2d]		; 0000190A  02672D  '.g-'
	daa				; 0000190D  27  0x27
	sub	[bx+si+0xa02b],dl	; 0000190E  28902BA0  '(.+.'
	mov	di,0x1f			; 00001912  BF1F00  '...'
	dec	di			; 00001915  4F  'O'
	or	ax,0xe			; 00001916  0D0E00  0x0D,'..'
	add	[bx+si],al		; 00001919  0000  '..'
	add	[si+0x8f8e],bl		; 0000191B  009C8E8F  '....'
	adc	al,0x1f			; 0000191F  141F  '..'
	xchg	ax,si			; 00001921  96  '.'
	mov	cx,0xffa3		; 00001922  B9A3FF  '...'
	add	[bx+di],al		; 00001925  0001  '..'
	add	al,[bp+di]		; 00001927  0203  '..'
	add	al,0x5			; 00001929  0405  '..'
	adc	al,0x7			; 0000192B  1407  '..'
	db	'89:;<=>?'
	or	al,0x0			; 00001935  0C00  '..'
	invd				; 00001937  0F08  '..'
	add	[bx+si],al		; 00001939  0000  '..'
	add	[bx+si],al		; 0000193B  0000  '..'
	add	[bx+si],dl		; 0000193D  0010  '..'
	push	cs			; 0000193F  0E  '.'
	add	bh,bh			; 00001940  00FF  '..'
	push	ax			; 00001942  50  'P'
	sbb	[bx+si],dl		; 00001943  1810  '..'
	add	[bx+si],dl		; 00001945  0010  '..'
	add	[bp+di],al		; 00001947  0003  '..'
	add	[bp+si],al		; 00001949  0002  '..'
	a32 pop	di			; 0000194B  675F  'g_'
	dec	di			; 0000194D  4F  'O'
	push	ax			; 0000194E  50  'P'
	db	0x82			; 0000194F  82  '.'
	push	bp			; 00001950  55  'U'
	cmp	word [bx+0x1f],0xd4f	; 00001951  81BF1F004F0D  '....O',0x0D
	push	cs			; 00001957  0E  '.'
	add	[bx+si],al		; 00001958  0000  '..'
	add	[bx+si],al		; 0000195A  0000  '..'
	pushf				; 0000195C  9C  '.'
	mov	cs,[bx+0x1f28]		; 0000195D  8E8F281F  '..(.'
	xchg	ax,si			; 00001961  96  '.'
	mov	cx,0xffa3		; 00001962  B9A3FF  '...'
	add	[bx+di],al		; 00001965  0001  '..'
	add	al,[bp+di]		; 00001967  0203  '..'
	add	al,0x5			; 00001969  0405  '..'
	adc	al,0x7			; 0000196B  1407  '..'
	db	'89:;<=>?'
	or	al,0x0			; 00001975  0C00  '..'
	invd				; 00001977  0F08  '..'
	add	[bx+si],al		; 00001979  0000  '..'
	add	[bx+si],al		; 0000197B  0000  '..'
	add	[bx+si],dl		; 0000197D  0010  '..'
	push	cs			; 0000197F  0E  '.'
	add	bh,bh			; 00001980  00FF  '..'
	push	ax			; 00001982  50  'P'
	sbb	[bx+si],dl		; 00001983  1810  '..'
	add	[bx+si],dl		; 00001985  0010  '..'
	add	[bp+di],al		; 00001987  0003  '..'
	add	[bp+si],al		; 00001989  0002  '..'
	pop	edi			; 0000198B  665F  'f_'
	dec	di			; 0000198D  4F  'O'
	push	ax			; 0000198E  50  'P'
	db	0x82			; 0000198F  82  '.'
	push	bp			; 00001990  55  'U'
	cmp	word [bx+0x1f],0xd4f	; 00001991  81BF1F004F0D  '....O',0x0D
	push	cs			; 00001997  0E  '.'
	add	[bx+si],al		; 00001998  0000  '..'
	add	[bx+si],al		; 0000199A  0000  '..'
	pushf				; 0000199C  9C  '.'
	mov	cs,[bx+0xf28]		; 0000199D  8E8F280F  '..(.'
	xchg	ax,si			; 000019A1  96  '.'
	mov	cx,0xffa3		; 000019A2  B9A3FF  '...'
	add	[bx+si],cl		; 000019A5  0008  '..'
	or	[bx+si],cl		; 000019A7  0808  '..'
	or	[bx+si],cl		; 000019A9  0808  '..'
	or	[bx+si],cl		; 000019AB  0808  '..'
	adc	[bx+si],bl		; 000019AD  1018  '..'
	sbb	[bx+si],bl		; 000019AF  1818  '..'
	sbb	[bx+si],bl		; 000019B1  1818  '..'
	sbb	[bx+si],bl		; 000019B3  1818  '..'
	push	cs			; 000019B5  0E  '.'
	add	[bx],cl			; 000019B6  000F  '..'
	or	[bx+si],al		; 000019B8  0800  '..'
	add	[bx+si],al		; 000019BA  0000  '..'
	add	[bx+si],al		; 000019BC  0000  '..'
	adc	[bp+si],cl		; 000019BE  100A  '.',0x0A
	add	bh,bh			; 000019C0  00FF  '..'
	push	ax			; 000019C2  50  'P'
	sbb	ax,0x10			; 000019C3  1D1000  '...'
	mov	al,[0xf01]		; 000019C6  A0010F  '...'
	add	[0x5fe3],al		; 000019C9  0006E35F  '..._'
	dec	di			; 000019CD  4F  'O'
	push	ax			; 000019CE  50  'P'
	db	0x82			; 000019CF  82  '.'
	push	sp			; 000019D0  54  'T'
	or	byte [bp+di],0x3e	; 000019D1  800B3E  '..>'
	add	[bx+si+0x0],al		; 000019D4  004000  '.@.'
	add	[bx+si],al		; 000019D7  0000  '..'
	add	[bx+si],al		; 000019D9  0000  '..'
	add	dl,ch			; 000019DB  00EA  '..'
	mov	di,ds			; 000019DD  8CDF  '..'
	sub	[bx+si],al		; 000019DF  2800  '(.'
	out	0x4,ax			; 000019E1  E704  '..'
	ret				; 000019E3  C3  '.'

	inc	word [bx+si]		; 000019E4  FF00  '..'
	aas				; 000019E6  3F  '?'
	aas				; 000019E7  3F  '?'
	aas				; 000019E8  3F  '?'
	aas				; 000019E9  3F  '?'
	...
	aas				; 000019F3  3F  '?'
	aas				; 000019F4  3F  '?'
	add	[bx+si],ax		; 000019F5  0100  '..'
	sldt	[bx+si]			; 000019F7  0F0000  '...'
	add	[bx+si],al		; 000019FA  0000  '..'
	add	[bx+si],al		; 000019FC  0000  '..'
	add	[di],al			; 000019FE  0005  '..'
	add	di,di			; 00001A00  01FF  '..'
	push	ax			; 00001A02  50  'P'
	sbb	ax,0x10			; 00001A03  1D1000  '...'
	mov	al,[0xf01]		; 00001A06  A0010F  '...'
	add	[0x5fe3],al		; 00001A09  0006E35F  '..._'
	dec	di			; 00001A0D  4F  'O'
	push	ax			; 00001A0E  50  'P'
	db	0x82			; 00001A0F  82  '.'
	push	sp			; 00001A10  54  'T'
	or	byte [bp+di],0x3e	; 00001A11  800B3E  '..>'
	add	[bx+si+0x0],al		; 00001A14  004000  '.@.'
	add	[bx+si],al		; 00001A17  0000  '..'
	add	[bx+si],al		; 00001A19  0000  '..'
	add	dl,ch			; 00001A1B  00EA  '..'
	mov	di,ds			; 00001A1D  8CDF  '..'
	sub	[bx+si],al		; 00001A1F  2800  '(.'
	out	0x4,ax			; 00001A21  E704  '..'
	db	0xE3,0xFF
	add	[bx+di],al		; 00001A25  0001  '..'
	add	al,[bp+di]		; 00001A27  0203  '..'
	add	al,0x5			; 00001A29  0405  '..'
	adc	al,0x7			; 00001A2B  1407  '..'
	db	'89:;<=>?'
	add	[bx+si],ax		; 00001A35  0100  '..'
	sldt	[bx+si]			; 00001A37  0F0000  '...'
	add	[bx+si],al		; 00001A3A  0000  '..'
	add	[bx+si],al		; 00001A3C  0000  '..'
	add	[di],al			; 00001A3E  0005  '..'
	ud0				; 00001A40  0FFF  '..'
	sub	[bx+si],bl		; 00001A42  2818  '(.'
	or	[bx+si],al		; 00001A44  0800  '..'
	and	[bx+di],al		; 00001A46  2001  ' .'
	str	[0x5f63]		; 00001A48  0F000E635F  '...c_'
	dec	di			; 00001A4D  4F  'O'
	push	ax			; 00001A4E  50  'P'
	db	0x82			; 00001A4F  82  '.'
	push	sp			; 00001A50  54  'T'
	cmp	byte [bx+0x1f],0x41	; 00001A51  80BF1F0041  '....A'
	add	[bx+si],al		; 00001A56  0000  '..'
	add	[bx+si],al		; 00001A58  0000  '..'
	add	[bx+si],al		; 00001A5A  0000  '..'
	pushf				; 00001A5C  9C  '.'
	mov	cs,[bx+0x4028]		; 00001A5D  8E8F2840  '..(@'
	xchg	ax,si			; 00001A61  96  '.'
	mov	cx,0xffa3		; 00001A62  B9A3FF  '...'
	add	[bx+di],al		; 00001A65  0001  '..'
	add	al,[bp+di]		; 00001A67  0203  '..'
	add	al,0x5			; 00001A69  0405  '..'
	push	es			; 00001A6B  06  '.'
	pop	es			; 00001A6C  07  '.'
	or	[bx+di],cl		; 00001A6D  0809  '..'
	or	cl,[bp+di]		; 00001A6F  0A0B  0x0A,'.'
	or	al,0xd			; 00001A71  0C0D  '.',0x0D
	push	cs			; 00001A73  0E  '.'
	cmovno	ax,[bx+si]		; 00001A74  0F4100  '.A.'
	sldt	[bx+si]			; 00001A77  0F0000  '...'
	add	[bx+si],al		; 00001A7A  0000  '..'
	add	[bx+si],al		; 00001A7C  0000  '..'
	inc	ax			; 00001A7E  40  '@'
	add	ax,0xff0f		; 00001A7F  050FFF  '...'
...
x2f9a:	push	cx			; 00002F9A  51  'Q'
	...
	add	[bx+di],al		; 00002FB1  0001  '..'
	add	al,[bp+di]		; 00002FB3  0203  '..'
	add	al,0x5			; 00002FB5  0405  '..'
	push	es			; 00002FB7  06  '.'
	pop	es			; 00002FB8  07  '.'
	or	[bx+di],cl		; 00002FB9  0809  '..'
	or	cl,[bp+di]		; 00002FBB  0A0B  0x0A,'.'
	or	al,0xd			; 00002FBD  0C0D  '.',0x0D
	push	cs			; 00002FBF  0E  '.'
	umov	[bx+di],dl		; 00002FC0  0F1011  '...'
	adc	dl,[bp+di]		; 00002FC3  1213  '..'
	adc	al,0x15			; 00002FC5  1415  '..'
	push	ss			; 00002FC7  16  '.'
	pop	ss			; 00002FC8  17  '.'
	sbb	[bx+di],bl		; 00002FC9  1819  '..'
	sbb	bl,[bp+di]		; 00002FCB  1A1B  '..'
	sbb	al,0x1d			; 00002FCD  1C1D  '..'
	push	ds			; 00002FCF  1E  '.'
	pop	ds			; 00002FD0  1F  '.'
	db	' !"#$%&',0x27,'()*+,-./0123456789:;<=>?'
	add	[di],al			; 00002FF1  0005  '..'
	adc	[si],bx			; 00002FF3  111C  '..'
	or	[bp+di],cl		; 00002FF5  080B  '..'
	and	ax,0x228		; 00002FF7  252802  '%(.'
	pop	es			; 00002FFA  07  '.'
	sbb	sp,[bx+si]		; 00002FFB  1B20  '. '
	unpcklps	xmm5,[bx+si]	; 00002FFD  0F1428  '..('
	sub	al,0xc			; 00003000  2C0C  ',.'
	adc	[di],sp			; 00003002  1125  '.%'
	sub	dl,[si]			; 00003004  2A14  '*.'
	push	ds			; 00003006  1E  '.'
	xor	dh,[0x130f]		; 00003007  32360F13  '26..'
	daa				; 0000300B  27  0x27
	sub	al,0x1b			; 0000300C  2C1B  ',.'
	and	[si],dh			; 0000300E  2034  ' 4'
	cmp	[0x1f0b],ax		; 00003010  39060B1F  '9...'
	and	al,0x13			; 00003014  2413  '$.'
	sbb	[si],ch			; 00003016  182C  '.,'
	xor	[bx+di],cl		; 00003018  3009  '0.'
	or	ax,0x2621		; 0000301A  0D2126  0x0D,'!&'
	adc	ax,0x2e1a		; 0000301D  151A2E  '...'
	xor	dx,[bp+di]		; 00003020  3313  '3.'
	pop	ss			; 00003022  17  '.'
	sub	si,[bx+si]		; 00003023  2B30  '+0'
	pop	ds			; 00003025  1F  '.'
	and	al,0x38			; 00003026  2438  '$8'
	cmp	ax,0x180e		; 00003028  3D0E18  '=..'
	sub	ax,0x2032		; 0000302B  2D3220  '-2 '
	and	al,0x38			; 0000302E  2438  '$8'
	aas				; 00003030  3F  '?'
	add	[bx+di],al		; 00003031  0001  '..'
	add	al,[bp+di]		; 00003033  0203  '..'
	add	al,0x5			; 00003035  0405  '..'
	adc	al,0x7			; 00003037  1407  '..'
	add	[bx+di],al		; 00003039  0001  '..'
	add	al,[bp+di]		; 0000303B  0203  '..'
	add	al,0x5			; 0000303D  0405  '..'
	adc	al,0x7			; 0000303F  1407  '..'
	db	'89:;<=>?89:;<=>?'
	add	[bx+di],al		; 00003051  0001  '..'
	add	al,[bp+di]		; 00003053  0203  '..'
	add	al,0x5			; 00003055  0405  '..'
	adc	al,0x7			; 00003057  1407  '..'
	add	[bx+di],al		; 00003059  0001  '..'
	add	al,[bp+di]		; 0000305B  0203  '..'
	add	al,0x5			; 0000305D  0405  '..'
	adc	al,0x7			; 0000305F  1407  '..'
	db	'89:;<=>?89:;<=>?'
	add	[di],al			; 00003071  0005  '..'
	adc	[si],bx			; 00003073  111C  '..'
	or	[bp+di],cl		; 00003075  080B  '..'
	adc	al,0x28			; 00003077  1428  '.('
	add	[di],al			; 00003079  0005  '..'
	adc	[si],bx			; 0000307B  111C  '..'
	or	[bp+di],cl		; 0000307D  080B  '..'
	adc	al,0x28			; 0000307F  1428  '.('
	push	cs			; 00003081  0E  '.'
	sbb	[di],ch			; 00003082  182D  '.-'
	xor	ah,[bx+si]		; 00003084  3220  '2 '
	and	al,0x38			; 00003086  2438  '$8'
	aas				; 00003088  3F  '?'
	push	cs			; 00003089  0E  '.'
	sbb	[di],ch			; 0000308A  182D  '.-'
	xor	ah,[bx+si]		; 0000308C  3220  '2 '
	and	al,0x38			; 0000308E  2438  '$8'
	aas				; 00003090  3F  '?'
	add	[di],al			; 00003091  0005  '..'
	adc	[si],bx			; 00003093  111C  '..'
	or	[bp+di],cl		; 00003095  080B  '..'
	adc	al,0x28			; 00003097  1428  '.('
	add	[di],al			; 00003099  0005  '..'
	adc	[si],bx			; 0000309B  111C  '..'
	or	[bp+di],cl		; 0000309D  080B  '..'
	adc	al,0x28			; 0000309F  1428  '.('
	push	cs			; 000030A1  0E  '.'
	sbb	[di],ch			; 000030A2  182D  '.-'
	xor	ah,[bx+si]		; 000030A4  3220  '2 '
	and	al,0x38			; 000030A6  2438  '$8'
	aas				; 000030A8  3F  '?'
	push	cs			; 000030A9  0E  '.'
	sbb	[di],ch			; 000030AA  182D  '.-'
	xor	ah,[bx+si]		; 000030AC  3220  '2 '
	and	al,0x38			; 000030AE  2438  '$8'
	aas				; 000030B0  3F  '?'

	times	4 dw 0x0000		; 000030B1 - 000030B7
	pop	es			; 000030B9  07  '.'
	pop	es			; 000030BA  07  '.'
	pop	es			; 000030BB  07  '.'
	pop	es			; 000030BC  07  '.'
	...
	times	4 dw 0x0000		; 000030D1 - 000030D7
	pop	es			; 000030D9  07  '.'
	pop	es			; 000030DA  07  '.'
	pop	es			; 000030DB  07  '.'
	pop	es			; 000030DC  07  '.'
	...
	aas				; 000030EF  3F  '?'
	aas				; 000030F0  3F  '?'
	add	[bx+di],al		; 000030F1  0001  '..'
	add	al,[bp+di]		; 000030F3  0203  '..'
	add	al,0x5			; 000030F5  0405  '..'
	adc	al,0x7			; 000030F7  1407  '..'
	db	'89:;<=>?'
	add	[di],al			; 00003101  0005  '..'
	adc	[si],bx			; 00003103  111C  '..'
	or	[bp+di],cl		; 00003105  080B  '..'
	adc	al,0x28			; 00003107  1428  '.('
	push	cs			; 00003109  0E  '.'
	sbb	[di],ch			; 0000310A  182D  '.-'
	xor	ah,[bx+si]		; 0000310C  3220  '2 '
	and	al,0x38			; 0000310E  2438  '$8'
	aas				; 00003110  3F  '?'
	add	[di],al			; 00003111  0005  '..'
	or	[bp+di],cl		; 00003113  080B  '..'
	push	cs			; 00003115  0E  '.'
	adc	[si],dx			; 00003116  1114  '..'
	sbb	[si],bl			; 00003118  181C  '..'
	db	' $(-28?'
	add	[bx+si],dl		; 00003121  0010  '..'
	pop	ds			; 00003123  1F  '.'
	das				; 00003124  2F  '/'
	aas				; 00003125  3F  '?'
	aas				; 00003126  3F  '?'
	...
	das				; 0000312E  2F  '/'
	pop	ds			; 0000312F  1F  '.'
	adc	[bx+si],al		; 00003130  1000  '..'
	add	[bx+si],al		; 00003132  0000  '..'
	add	[bx+si],al		; 00003134  0000  '..'
	add	[bx+si],al		; 00003136  0000  '..'
	add	[bx],bl			; 00003138  001F  '..'
	daa				; 0000313A  27  0x27
	das				; 0000313B  2F  '/'
	aaa				; 0000313C  37  '7'
	aas				; 0000313D  3F  '?'
	aas				; 0000313E  3F  '?'
	...
	pop	ds			; 00003150  1F  '.'
	db	'-16:?????????:61-------'
	sub	ax,0x700		; 00003168  2D0007  '-..'
	push	cs			; 0000316B  0E  '.'
	adc	ax,0x1c1c		; 0000316C  151C1C  '...'
	sbb	al,0x1c			; 0000316F  1C1C  '..'
	sbb	al,0x1c			; 00003171  1C1C  '..'
	sbb	al,0x1c			; 00003173  1C1C  '..'
	sbb	al,0x15			; 00003175  1C15  '..'
	push	cs			; 00003177  0E  '.'
	pop	es			; 00003178  07  '.'

	times	4 dw 0x0000		; 00003179 - 0000317F
	push	cs			; 00003181  0E  '.'
	adc	[di],dx			; 00003182  1115  '..'
	sbb	[si],bl			; 00003184  181C  '..'
	sbb	al,0x1c			; 00003186  1C1C  '..'
	sbb	al,0x1c			; 00003188  1C1C  '..'
	sbb	al,0x1c			; 0000318A  1C1C  '..'
	sbb	al,0x1c			; 0000318C  1C1C  '..'
	sbb	[di],dl			; 0000318E  1815  '..'
	adc	[0xe0e],cx		; 00003190  110E0E0E  '....'
	push	cs			; 00003194  0E  '.'
	push	cs			; 00003195  0E  '.'
	push	cs			; 00003196  0E  '.'
	push	cs			; 00003197  0E  '.'
	push	cs			; 00003198  0E  '.'
	adc	al,0x16			; 00003199  1416  '..'
	sbb	[bp+si],bl		; 0000319B  181A  '..'
	sbb	al,0x1c			; 0000319D  1C1C  '..'
	sbb	al,0x1c			; 0000319F  1C1C  '..'
	sbb	al,0x1c			; 000031A1  1C1C  '..'
	sbb	al,0x1c			; 000031A3  1C1C  '..'
	sbb	al,0x1a			; 000031A5  1C1A  '..'
	sbb	[0x1414],dl		; 000031A7  18161414  '....'
	adc	al,0x14			; 000031AB  1414  '..'
	adc	al,0x14			; 000031AD  1414  '..'
	adc	al,0x14			; 000031AF  1414  '..'
	add	[si],al			; 000031B1  0004  '..'
	or	[si],cl			; 000031B3  080C  '..'
	adc	[bx+si],dl		; 000031B5  1010  '..'
	adc	[bx+si],dl		; 000031B7  1010  '..'
	adc	[bx+si],dl		; 000031B9  1010  '..'
	adc	[bx+si],dl		; 000031BB  1010  '..'
	adc	[si],cl			; 000031BD  100C  '..'
	or	[si],al			; 000031BF  0804  '..'

	times	4 dw 0x0000		; 000031C1 - 000031C7
	or	[bp+si],cl		; 000031C9  080A  '.',0x0A
	or	al,0xe			; 000031CB  0C0E  '..'
	adc	[bx+si],dl		; 000031CD  1010  '..'
	adc	[bx+si],dl		; 000031CF  1010  '..'
	adc	[bx+si],dl		; 000031D1  1010  '..'
	adc	[bx+si],dl		; 000031D3  1010  '..'
	adc	[0xa0c],cl		; 000031D5  100E0C0A  '...',0x0A
	or	[bx+si],cl		; 000031D9  0808  '..'
	or	[bx+si],cl		; 000031DB  0808  '..'
	or	[bx+si],cl		; 000031DD  0808  '..'
	or	[bx+si],cl		; 000031DF  0808  '..'
	or	cx,[si]			; 000031E1  0B0C  '..'
	or	ax,0x100f		; 000031E3  0D0F10  0x0D,'..'
	adc	[bx+si],dl		; 000031E6  1010  '..'
	adc	[bx+si],dl		; 000031E8  1010  '..'
	adc	[bx+si],dl		; 000031EA  1010  '..'
	adc	[bx+si],dl		; 000031EC  1010  '..'
	prefetchw	[si]		; 000031EE  0F0D0C  '.',0x0D,'.'
	or	cx,[bp+di]		; 000031F1  0B0B  '..'
	or	cx,[bp+di]		; 000031F3  0B0B  '..'
	or	cx,[bp+di]		; 000031F5  0B0B  '..'
	or	cx,[bp+di]		; 000031F7  0B0B  '..'
