...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pcx86/1.33.0/common.xsl"/>
	<xsl:include href="/versions/pcx86/1.33.0/document.xsl"/>
	<xsl:include href="/versions/pcx86/1.33.0/components.xsl"/>
