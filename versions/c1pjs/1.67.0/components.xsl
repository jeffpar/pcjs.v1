...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="componentStyles">
		<link rel="stylesheet" type="text/css" href="/versions/c1pjs/1.67.0/components.css"/>
	</xsl:template>
		...
		<div id="{$id}" class="{$componentClass}" style="{$width}{$height}{$pos}{$left}{$top}{$padding}">
			...
			<xsl:if test="$component = 'machine'">
				...
				<div class="{$APPCLASS}-copyright">
					<a href="http://{$SITEHOST}/{$APPCLASS}" target="_blank">C1Pjs</a> v<xsl:value-of select="$APPVERSION"/> © 2012-2018 by <a href="http://jeffpar.com" target="_blank">@jeffpar</a>
				</div>
