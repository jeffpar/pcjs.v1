...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pcjs/1.15.4/common.xsl"/>
	<xsl:include href="/versions/pcjs/1.15.4/document.xsl"/>
	<xsl:include href="/versions/pcjs/1.15.4/components.xsl"/>
