...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pdpjs/1.72.3/common.xsl"/>
	<xsl:include href="/versions/pdpjs/1.72.3/document.xsl"/>
	<xsl:include href="/versions/pdpjs/1.72.3/components.xsl"/>
