...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pdpjs/1.36.2/common.xsl"/>
	<xsl:include href="/versions/pdpjs/1.36.2/document.xsl"/>
	<xsl:include href="/versions/pdpjs/1.36.2/components.xsl"/>
