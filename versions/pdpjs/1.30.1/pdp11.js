...
g.oa=function(a){if(this.b&&(a||!this.a.h.S||this.h.bb)){for(a=0;a<this.a.f.length;a++)E(this,"R"+a,this.a.f[a]);a=Na(this.a);E(this,"PS",a);E(this,"NF",a&8?1:0,1);E(this,"ZF",a&4?1:0,1);E(this,"VF",a&2?1:0,1);E(this,"CF",a&1?1:0,1);Ma(this,"D",this.a.f[0],16);Ma(this,"A",this.a.f[7],22)}};function La(){for(var a=!1,b=C(document,"pdp11","panel"),c=0;c<b.length;c++){var d=b[c],e=A(d),f=Ha(e.id);f||(a=!0,f=new Ka(e));B(f,d);a&&D(f)}}t(La);
function Oa(a,b,c){v.call(this,"Bus",a,Oa);this.a=b;this.I=c;this.B=a.busWidth||16;this.m=0;this.H=[];this.w=null;this.D=Math.pow(2,this.B);this.i=this.D-1|0;this.c=(this.B>>1)+2;10>this.c&&(this.c=10);15<this.c&&(this.c=15);this.l=1<<this.c;this.F=this.l>>2;this.g=this.l-1;this.A=this.D/this.l|0;this.ga=[];this.o=0;this.s=[];this.wb=[Pa,Qa,Ra,Sa];a=new G(this);Ta(a,this.I);this.b=Array(this.A);for(b=0;b<this.A;b++)this.b[b]=a;D(this)}x(Oa);
...
function eb(a){for(var b=0,c=[],d=0;d<a.A;d++){var e=a.b[d];if(e.ha||e.yb){c[b++]=d;var f=b++;if(e=e.save()){for(var h=0,l=0,n=[];h<e.length;){for(var p=e[h],u=h+1;u<e.length&&e[u]===p;)u++;n[l++]=u-h;n[l++]=p;h=u}n.length<e.length&&(e=n)}c[f]=e}}return c}function fb(a,b,c,d,e,f,h,l){for(;b<=c;b+=2){var n=b&8191;void 0!==a.ga[n]?q("I/O address already registered: "+k(b,8,!0)):a.ga[n]=[d,e,f,h,l||"unknown",!1]}}
...
c,!0;case "setSpeed":return this.v[b]=c,c.onclick=function(){Jb(d,d.Z<<1)},c.textContent=this.da.toFixed(2)+"Mhz",!0}return!1};g.oa=function(){var a=this.v.speed;a&&(a.textContent=this.h.S&&this.W?this.W.toFixed(2)+"Mhz":"Stopped")};function Kb(a,b,c){a.$+=b;c&&(a.Y=a.a=0)}function Lb(a,b){var c=1;b&&1<a.Z&&a.W&&(c=a.W/a.Ua);a.hb=Math.round(1E3/30);a.Ja=Math.floor(a.Ia/30*c);b||(a.ra=a.Ja);a.Wa=0}function Mb(a){return a.$+a.R+a.Y-a.a}function Gb(a){a.W=0;a.ib=0;a.$=a.R=a.Y=a.a=0;Hb(a);Jb(a,1)}
function Jb(a,b){if(void 0!==b&&(.8>a.W/a.da&&(b=1),a.Z=b,b=a.Ua*a.Z,a.da!=b)){a.da=b;b=a.da.toFixed(2)+"Mhz";var c=a.v.setSpeed;c&&(c.textContent=b);a.M("target speed: "+b)}Kb(a,a.R);a.R=0;a.P=ka();a.X=0;Lb(a)}function jb(a,b){var c=a.H.length;a.H.push([-1,b]);return c}function lb(a,b,c){0<=b&&b<a.H.length&&0>a.H[b][0]&&(c*=a.Ia*a.Z/1E3,a.H[b][0]=c)}
...
function Pb(a){a.na=255;a.G=0;a.$a=0;a.B=0;a.la=0;a.Za=0;a.ma=0;a.Na=0;a.Da=0;a.Va=262143;a.Fa=253952;a.s=[];a.j|=2;a.l&&mb(a)}function mb(a){a.Na?(a.V=65536,a.J=a.Ab,a.N=a.nb,a.kb=a.Sc,Va(a.l,a.ma&16?22:18)):(a.V=0,a.J=a.zb,a.N=a.kc,a.kb=a.Rc,Va(a.l,16))}g.eb=function(){return 0};g.save=function(){var a=new L(this);a.set(0,[]);a.set(1,[this.$,this.Z]);a.set(2,eb(this.l));return a.data()};
g.restore=function(a){var b=a[1];this.$=b[1];Jb(this,b[3]);a:{b=this.l;a=a[2];var c;for(c=0;c<a.length-1;c+=2){var d=a[c],e=a[c+1];if(e&&e.length<b.F){for(var f=0,h=Array(b.F),l=0;l<e.length-1;)for(var n=e[l++],p=e[l++];n--;)h[f++]=p;e=h}f=b.b[d];if(!f||!f.restore(e)){q("Unable to restore memory block "+d);b=!1;break a}}b=!0}return b};function M(a){return a.m&65536?1:0}g.ia=function(){return this.o&32768?8:0};function Qb(a){var b=a.N(a.f[7]);a.f[7]=a.f[7]+2&65535;return b}
function kb(a,b,c,d,e){for(var f=a.s.length;0<f--;)if(a.s[f].sb===d){0<f&&(a.s[f-1].aa+=a.s[f].aa);a.s.splice(f,1);break}if(0<=b){for(f=a.s.length;0<f--;){if(a.s[f].aa>b){a.s[f].aa-=b;break}b-=a.s[f].aa}a.s.splice(f+1,0,{aa:b,lb:c<<5&224,sb:d,Qa:e})}a.j|=2}function Na(a){return a.u=a.u&63728|a.ia()|(a.i&65535?0:4)|(a.g&32768?2:0)|M(a)}
...
function H(a,b){var c=!1;0>a.fa?a.fa=Na(a):a.w||(b=4,c=!0);a.B&57344||(a.la=63222,a.Za=b);a.w=0;var d=a.N(b|a.V),e=a.N(b+2&65535|a.V);ob(a,e&-12289|a.fa>>2&12288);c&&(a.G|=4,a.f[6]=4);Tb(a,a.fa);Tb(a,a.f[7]);a.f[7]=d&65535;a.j&=-113;a.fa=-1;throw b;}function Ub(a){var b=Vb(a),c=Vb(a)&-1793;a.u&49152&&(c=c&-225|a.u&63712);a.f[7]=b&65535;ob(a,c);a.j&=-17}
function Wb(a,b,c){var d,e,f,h=0;d=b>>13;a.ma&a.Bb[a.w]||(d&=7);e=a.C[a.w][d];f=(a.O[a.w][d]<<6)+(b&8191)&a.Va;if(f<a.Fa)f&1&&!(c&1)&&(a.G|=64,H(a,4));else if(a.ma&16||253952<=f&&(f|=4186112),4186112>f){if(3932160<=f){f&=262143;var l=f>>13&31;31>l?a.ma&32&&(f=a.Fb[l]+(f&8190)&4194302,3932160<=f&&4186112>f&&console.log("panic(898)")):f|=4186112}f>=a.Fa&&4186112>f&&(a.G|=32,H(a,4))}switch(e&7){case 1:h=4096;case 2:e|=128;c&4&&(h=8192);break;case 4:h=4096;case 5:c&4&&(h=4096);case 6:e|=c&4?192:128;break;
default:h=32768}32512!==(e&32520)&&(e&8?e&32512&&(b&8128)<(e>>2&8128)&&(h|=16384):(b&8128)>(e>>2&8128)&&(h|=16384));a.C[a.w][d]=e;if(4194170!==f||a.w)a.Da=a.w,a.Ea=d;h&&(h&57344&&(0<=a.fa&&(h|=128),a.B&57344||(a.B=a.B|h|a.Da<<5|a.Ea<<1),H(a,168)),a.B&61440||!(4191360>f||4194239<f)||(a.B|=4096,a.B&512&&(a.j|=32)));return f}function Vb(a){var b=a.N(a.f[6]|a.V);a.f[6]=a.f[6]+2&65535;return b}
function Tb(a,b){var c=a.f[6]-2&65535;a.f[6]=c;a.B&57344||(a.la=a.la<<8|246);!a.w&&c<=a.na&&4<c&&(c<=a.na-32?(a.G|=4,a.f[6]=4,H(a,4)):(a.G|=8,a.j|=4));a.kb(c,b)}
function Xb(a,b,c,d){var e,f,h=d&8?0:a.V;switch(b){case 0:return H(a,4),0;case 1:return 6===c&&!a.w&&d&4&&(a.f[6]<=a.na||65534<=a.f[6])&&(a.f[6]<=a.na-32||65534<=a.f[6]?(a.G|=4,a.f[6]=4,H(a,4)):(a.G|=8,a.j|=64)),a.a-=3,7===c?a.f[c]:a.f[c]|h;case 2:f=2;e=a.f[c];7!==c&&(e|=h,6>c&&d&1&&(f=1));a.a-=3;break;case 3:f=2;e=a.f[c];7!==c&&(e|=h);e=a.N(e);e|=h;a.a-=7;break;case 4:f=-2;6>c&&d&1&&(f=-1);e=a.f[c]+f&65535;7!==c&&(e|=h);a.a-=4;break;case 5:f=-2;e=a.f[c]-2&65535;7!==c&&(e|=h);e=a.N(e)|h;a.a-=8;break;
...
this.f[7]+2&65535,this.j&=-5),a?H(this,a.sb):H(this,160))}else this.j&1&&this.j++;this.B&57344||(this.la=0,this.Za=this.f[7]);this.j=this.j&7|this.u&16;this.decode(Qb(this))}while(0<this.a);return this.h.complete?this.Y-this.a:void 0===this.h.complete?0:-1};t(function(){for(var a=C(document,"pdp11","cpu"),b=0;b<a.length;b++){var c=a[b],d=A(c),d=new Nb(d);B(d,c)}});function ec(a,b){var c=b+a;Rb(this,c,a,b);return c&65535}function fc(a,b){var c=b+a;Rb(this,c<<8,a<<8,b<<8);return c&255}
...
g.ja=function(a,b,c,d){this.A=a;this.l=b;this.a=c;this.I=d;var e=this;this.J=jb(this.a,function(){e.b&128||!e.i.length||(e.F=e.i.shift(),e.b|=128,e.b&64&&kb(e.a,40,4,48))});this.D=function(){e.c|=128;return!!(e.c&64)};gb(b,this,nd);D(this)};
...
this.M("PDPjs v1.30.1\nCopyright \u00a9 2012-2016 Jeff Parsons <Jeff@pcjs.org>\nLicense: GPL version 3 or later <http://gnu.org/licenses/gpl.html>");this.M("Portions adapted from the PDP-11/70 Emulator v1.4 by Paul Nankervis <paulnank@hotmail.com>");for(b=0;b<e.length;b++)d=e[b],d.ja&&d.ja(this,this.l,this.a,this.I);b=null;d=a.resume;void 0!==d&&(1<d.length?b=this.s=d:this.b=parseInt(d,10));var f;if(a=Fb(this,"state")||(f=!0,a.state))b=this.D=a,f||(this.o=!0,this.b=sd),this.b&&(this.w=new L(this,
...
g.stop=function(a,b){for(var c=y(this.id),d=0;d<c.length;d++){var e=c[d];"CPU"!=e.type&&e!==this&&e.stop&&e.stop(a,b)}this.oa(!0)};
...
g.oa=function(a){this.a&&this.a.oa(a);this.i&&this.i.oa(a)};t(function(){for(var a=C(document,"pdp11-machine"),b=0;b<a.length;b++)for(var c=a[b],d=A(c),c=C(c,"pdp11","computer"),e=0;e<c.length;e++){var f=c[e],h=A(f),h=new qd(h,d,!0);B(h,f);h.B&&wd(h,h.Aa)}});r.show.push(function(){for(var a=C(document,"pdp11","computer"),b=0;b<a.length;b++){var c=A(a[b]);(c=z("Computer",c.id))&&c.R&&!c.h.L&&c.Aa(-1)}});
