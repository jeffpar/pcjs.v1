...
g.ba=function(a){if(this.b&&(a||!this.a.h.S||this.h.$a)){for(a=0;a<this.a.f.length;a++)E(this,"R"+a,this.a.f[a]);a=Na(this.a);E(this,"PS",a);E(this,"NF",a&8?1:0,1);E(this,"ZF",a&4?1:0,1);E(this,"VF",a&2?1:0,1);E(this,"CF",a&1?1:0,1);Ma(this,"D",this.a.f[0],16);Ma(this,"A",this.a.f[7],22)}};function La(){for(var a=!1,b=C(document,"pdp11","panel"),c=0;c<b.length;c++){var d=b[c],e=A(d),f=Ha(e.id);f||(a=!0,f=new Ka(e));B(f,d);a&&D(f)}}u(La);
...
function Ya(a,b,c,d,e){for(var f=b,h=c,l=f>>>a.c;0<h&&l<a.b.length;){var n=a.b[l],q=l*a.j,t=a.j-(f-q);t>h&&(t=h);if(!e&&n&&n.size){if(n.type==d){if(f+h<=n.xa)return n.Oa+=n.xa-f,n.xa=f,!0;if(f>=n.xa+n.Oa){t=n.size-(f-q);t>h&&(t=h);n.Oa=f-n.xa+t;f=q+a.j;h-=t;l++;continue}}return $a(1,f,h)}f=new G(a,f,t,a.j,d,e);Ta(f,a.I,n);a.b[l++]=f;f=q+a.j;h-=t}return 0>=h?(a.status(Math.floor(c/1024)+"Kb "+ab[d]+" at "+k(b,8,!0)),!0):$a(2,b,c)}
...
g.sa=function(a){a&=7;return this.a.u&2048?this.a.ra[a]:this.a.f[a]};g.ua=function(a,b){b&=7;this.a.u&2048?this.a.ra[b]=a:this.a.f[b]=a};g.Rb=function(){return this.a.u&49152?this.a.V[0]:this.a.f[6]};g.Ac=function(a){this.a.u&49152?this.a.V[0]=a:this.a.f[6]=a};g.Ub=function(){return this.a.f[7]};g.Dc=function(a){this.a.f[7]=a};g.ta=function(a){a&=7;return this.a.u&2048?this.a.f[a]:this.a.ra[a]};g.va=function(a,b){b&=7;this.a.u&2048?this.a.f[b]=a:this.a.ra[b]=a};
...
b&255,c++);this.Pa(a,b>>8,c)},M:function(a){return this.a[a>>2]>>>((a&3)<<3)&255},X:function(a,b){a&1&&ib(this.j,b);b=a>>2;a=(a&3)<<3;var c=this.a[b]>>a;return 24>a?c&65535:c&255|(this.a[b+1]&255)<<8},da:function(a,b){var c=a>>2;a=(a&3)<<3;this.a[c]=this.a[c]&~(255<<a)|b<<a;this.ha=!0},qa:function(a,b,c){a&1&&ib(this.j,c);c=a>>2;a=(a&3)<<3;24>a?this.a[c]=this.a[c]&~(65535<<a)|b<<a:(this.a[c]=this.a[c]&16777215|b<<24,c++,this.a[c]=this.a[c]&-256|b>>8);this.ha=!0},G:function(a,b){return this.H(a,b)},
...
g.ja=function(a,b,c,d){this.w=a;this.j=b;this.I=d;for(b=0;b<Fb.length;b++)(c=this.v[Fb[b]])&&this.w.T(null,Fb[b],c);a=Gb(a,"autoStart");null!=a&&(this.h.ya="true"==a?!0:"false"==a?!1:!!a);D(this)};g.reset=function(){};g.save=function(){return null};g.restore=function(){return!1};g.aa=function(a,b){if(!b){if(a&&this.restore){Hb(this);if(!this.restore(a))return!1;Ib(this)}else this.reset();this.O("No debugger detected")}this.w.ba();return!0};g.$=function(a){return a?this.save():!0};
g.ya=function(){return this.h.ya||void 0===this.v.run?(Jb(this),!0):!1};g.bb=function(){return 0};function Ib(a){void 0===a.Ha&&(a.Ha=0);void 0===a.oa&&(a.oa=-1);void 0===a.pa&&(a.pa=-1);a.h.Ka=0<=a.Ha&&0<a.oa;a.h.Ka&&(a.Ba=0,a.ea=a.Ha-a.J)}
...
c,!0;case "setSpeed":return this.v[b]=c,c.onclick=function(){Kb(d,d.Z<<1)},c.textContent=this.ca.toFixed(2)+"Mhz",!0}return!1};g.ba=function(){var a=this.v.speed;a&&(a.textContent=this.h.S&&this.X?this.X.toFixed(2)+"Mhz":"Stopped")};function Lb(a,b){var c=1;b&&1<a.Z&&a.X&&(c=a.X/a.Ta);a.fb=Math.round(1E3/30);a.Ja=Math.floor(a.Ia/30*c);b||(a.qa=a.Ja);a.Va=0}function Mb(a){return a.J+a.R+a.da-a.a}function Hb(a){a.X=0;a.gb=0;a.J=a.R=a.da=a.a=0;Ib(a);Kb(a,1)}
...
g.kc=function(){if(this.h.S){this.Va>=this.Ia&&Lb(this,!0);this.wa=0;this.Ga=ka();if(this.Y){var a=this.Ga-this.Y;a>this.fb&&(this.N+=a,this.N>this.Ga&&(this.N=this.Ga))}try{do{for(var b,c=this.h.Ka?1:this.Ja,d=this.G.length-1;0<=d;d--){var e=this.G[d];0>e[0]||c>e[0]&&(c=e[0])}b=c;try{this.pb(b)}catch(n){if("number"!=typeof n)throw n;}b=Nb(this,!0);this.wa+=b;this.R+=b;a=b;if(this.h.Ka){var f=!1;this.Ba=this.Ba+this.bb()|0;this.ea-=a;0>=this.ea&&(this.ea+=this.oa,f=!0);0<=this.pa&&this.pa<=Mb(this)&&
(this.oa=this.pa=-1,Ib(this),F(this),f=!0);f&&this.O(Mb(this)+" cycles: checksum="+k(this.Ba))}for(var a=b,h=this.G.length-1;0<=h;h--){var l=this.G[h];0>l[0]||(l[0]-=a,0>=l[0]&&(l[0]=-1,l[1]()))}this.qa-=b;if(0>=this.qa){this.qa+=this.Ja;15<=++this.gb&&(this.w&&this.w.ba(),this.gb=0);break}}while(this.h.S)}catch(n){F(this);this.w&&this.w.stop(ka(),Mb(this));b=n.stack||n.message;this.h.error=!0;this.K(b);return}if(this.h.S){b=setTimeout;c=this.hb;this.Y=ka();d=this.fb;this.wa&&(d=Math.round(d*this.wa/
this.Ja));d-=this.Y-this.Ga;if(e=this.Y-this.N)this.X=Math.round(this.R/(10*e))/100,864E5<=e&&(this.J=0,Kb(this));if(0>d||this.X<this.ca)-1E3>d&&(this.N-=d),d=0;this.Va+=this.wa;this.Y+=d;b(c,d)}}};function Jb(a){var b;a.h.error?(a.O(a.toString()+" error"),b=!0):b=!1;if(!b)if(a.h.S)a.O(a.toString()+" busy");else{Kb(a);a.h.S=!0;a.h.ob=!0;if(b=a.v.run)b.textContent="Halt";a.w&&a.w.start(a.N,Mb(a));setTimeout(a.hb,0)}}g.pb=function(){return 0};
...
function Qb(a){a.na=255;a.F=0;a.mb=0;a.A=0;a.la=0;a.Ya=0;a.ma=0;a.Na=0;a.Da=0;a.Ua=262143;a.Fa=253952;a.l|=2;a.j&&nb(a)}function nb(a){a.Na?(a.W=65536,a.H=a.xb,a.M=a.kb,a.ib=a.Sc,Va(a.j,a.ma&16?22:18)):(a.W=0,a.H=a.wb,a.M=a.hc,a.ib=a.Rc,Va(a.j,16))}g.bb=function(){return 0};g.save=function(){var a=new L(this);a.set(0,[]);a.set(1,[this.J,this.Z]);a.set(2,eb(this.j));return a.data()};
...
function mb(a,b,c){b={nc:b,Aa:c,request:-1,next:null};a.yb.push(b);return b}function kb(a,b){var c;c=b.nc;b.Aa>(a.u&224)>>5?(a.l&4&&(a.f[7]=a.f[7]+2&65535,a.l&=-5),H(a,c,26),c=!0):c=!1;if(!c){if(b!=a.U)if(c=a.U,!c||c.Aa<=b.Aa)b.next=c,a.U=b;else{do{a=c.next;if(!a||a.Aa<=b.Aa){b.next=a;c.next=b;break}c=a}while(1)}return!1}return!0}function Na(a){return a.u=a.u&63728|a.ia()|(a.i&65535?0:4)|(a.g&32768?2:0)|M(a)}
...
function H(a,b,c){var d=!1;0>a.fa?a.fa=Na(a):a.s||(b=4,d=!0);a.A&57344||(a.la=63222,a.Ya=b);a.s=0;var e=a.M(b|a.W),f=a.M(b+2&65535|a.W);pb(a,f&-12289|a.fa>>2&12288);d&&(a.F|=4,a.f[6]=4);Ub(a,a.fa);Ub(a,a.f[7]);a.f[7]=e&65535;a.l&=-113;a.fa=-1;if(26!=c)throw b;}function Vb(a){var b=Wb(a),c=Wb(a)&-1793;a.u&49152&&(c=c&-225|a.u&63712);a.f[7]=b&65535;pb(a,c);a.l&=-17}
...
128;break;default:h=32768}32512!==(e&32520)&&(e&8?e&32512&&(b&8128)<(e>>2&8128)&&(h|=16384):(b&8128)>(e>>2&8128)&&(h|=16384));a.C[a.s][d]=e;if(4194170!==f||a.s)a.Da=a.s,a.Ea=d;h&&(h&57344&&(0<=a.fa&&(h|=128),a.A&57344||(a.A=a.A|h|a.Da<<5|a.Ea<<1),H(a,168,16)),a.A&61440||!(4191360>f||4194239<f)||(a.A|=4096,a.A&512&&(a.l|=32)));return f}function Wb(a){var b=a.M(a.f[6]|a.W);a.f[6]=a.f[6]+2&65535;return b}
function Ub(a,b){var c=a.f[6]-2&65535;a.f[6]=c;a.A&57344||(a.la=a.la<<8|246);!a.s&&c<=a.na&&4<c&&(c<=a.na-32?(a.F|=4,a.f[6]=4,H(a,4,18)):(a.F|=8,a.l|=4));a.ib(c,b)}
function Yb(a,b,c,d){var e,f,h=d&8?0:a.W;switch(b){case 0:return H(a,4,20),0;case 1:return 6===c&&!a.s&&d&4&&(a.f[6]<=a.na||65534<=a.f[6])&&(a.f[6]<=a.na-32||65534<=a.f[6]?(a.F|=4,a.f[6]=4,H(a,4,22)):(a.F|=8,a.l|=64)),a.a-=3,7===c?a.f[c]:a.f[c]|h;case 2:f=2;e=a.f[c];7!==c&&(e|=h,6>c&&d&1&&(f=1));a.a-=3;break;case 3:f=2;e=a.f[c];7!==c&&(e|=h);e=a.M(e);e|=h;a.a-=7;break;case 4:f=-2;6>c&&d&1&&(f=-1);e=a.f[c]+f&65535;7!==c&&(e|=h);a.a-=4;break;case 5:f=-2;e=a.f[c]-2&65535;7!==c&&(e|=h);e=a.M(e)|h;a.a-=
8;break;case 6:return e=Rb(a),e=e+a.f[c]&65535|h,a.a-=6,e;case 7:return e=Rb(a),e=e+a.f[c]&65535,e=a.M(e|a.W)|h,a.a-=10,e}a.f[c]=a.f[c]+f&65535;!h||a.A&57344||(a.la=a.la<<8|f<<3&248|c);6==c&&!a.s&&d&4&&0>=f&&(a.f[6]<=a.na||65534<=a.f[6])&&(a.f[6]<=a.na-32?(a.F|=4,a.f[6]=4,H(a,4,24)):(a.F|=8,a.l|=64));return e}g.wb=function(a,b,c){return Yb(this,a,b,c)};g.xb=function(a,b,c){return Xb(this,Yb(this,a,b,c),c)};g.hc=function(a){return cb(this.j,a)};g.kb=function(a){return cb(this.j,Xb(this,a,2))};
g.Rc=function(a,b){db(this.j,a,b&65535)};g.Sc=function(a,b){db(this.j,Xb(this,a,4),b)};function Zb(a,b,c){var d=a.b=b&7;(b=a.c=(b&56)>>3)?(d=Yb(a,b,d,2),c&65536||61440!==(a.u&61440)&&(d&=65535),a.s=a.u>>12&3,c=a.M(d|c&a.W),a.s=a.u>>14&3):c=6!=d||(a.u>>2&12288)===(a.u&12288)?a.f[d]:a.V[a.u>>12&3];return c}
...
g.pb=function(a){this.h.complete=!0;this.h.ub=!1;this.h.ob=!1;this.da=this.a=a;do{if(this.l&&(this.l&112&&(this.l&32?H(this,168,28):this.l&64?H(this,4,30):this.l&16&&H(this,12,32),this.l&=-113),this.l&7))if(this.l&2){if(this.l&=-3,this.U&&kb(this,this.U)){var b=a=this.U;if(b==a)this.U=a.next;else{do{var c=b.next;if(c==a){b.next=c.next;break}b=c}while(1)}}}else this.l&1&&this.l++;this.A&57344||(this.la=0,this.Ya=this.f[7]);this.l=this.l&7|this.u&16;this.decode(Rb(this))}while(0<this.a);return this.h.complete?
this.da-this.a:void 0===this.h.complete?0:-1};u(function(){for(var a=C(document,"pdp11","cpu"),b=0;b<a.length;b++){var c=a[b],d=A(c),d=new Ob(d);B(d,c)}});function fc(a,b){var c=b+a;Sb(this,c,a,b);return c&65535}function gc(a,b){var c=b+a;Sb(this,c<<8,a<<8,b<<8);return c&255}function hc(a,b){a=b<<1;P(this,a);return a&65535}function ic(a,b){a=b<<1;P(this,a<<8);return a&255}function jc(a,b){a=b&32768|b>>1|b<<16;P(this,a);return a&65535}function kc(a,b){a=b&2048|b>>1|b<<8;P(this,a<<8);return a&255}
...
g.eb=function(){if(!this.s){var a=Gb(this.w,"connection");if(a){var b=a.split("->");if(2==b.length){var c=ia(b[0]);if(c!=this.Ca)return;b=ia(b[1]);if(this.s=Ha(b)){var d=this.s.exports;if(d){var e=d.connect;e&&e.call(this.s);if(this.A=d.receiveData){this.status(this.Sa+"."+c+" connected to "+b);return}}}}this.status("Unable to establish connection: "+a)}}};g.aa=function(a,b){if(!b)if(this.eb(),!a||!this.restore)this.reset();else if(!this.restore(a))return!1;return!0};
...
"1.30.1"),vd(this.A)?b=null:delete this.A);!b&&this.b&&(b=wd(this))&&(this.o=!0);if(b){var h=this;m(b,null,!0,function(a,b,c){c?(h.w=null,h.o=!1,h.K("Unable to load machine state from server (error "+c+(b?": "+ia(b):"")+")")):(h.s=b,h.H=!0);D(h)})}else D(this);this.v.power||(this.B=!0);!c&&this.B&&xd(this,this.za)}else p("Unable to find CPU component")}x(rd);var td=0;
...
function Dd(a,b,c,d,e){if(!b.h.L){b.h.L=!0;if(b.aa){var f=null;e&&((f=c.get(b.id))||(f=c.get(b.id.replace(/[a-z0-9]\./i,"."))));"string"===typeof f&&(f=null);!b.aa(f,d)&&f&&(p("Unable to restore state for "+b.type),a.D&&!a.H?(c.clear(),a.b=td,window&&window.location.reload()):a.G=!0,b.aa(null),e=!1)}if(!d&&b.cb)for(a=b.cb.split("|"),c=0;c<a.length;c++)b.status(a[c])}return e}
