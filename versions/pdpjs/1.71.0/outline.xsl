...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pdpjs/1.71.0/common.xsl"/>
	<xsl:include href="/versions/pdpjs/1.71.0/document.xsl"/>
	<xsl:include href="/versions/pdpjs/1.71.0/components.xsl"/>
