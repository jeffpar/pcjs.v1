...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pc8080/1.71.3/common.xsl"/>
	<xsl:include href="/versions/pc8080/1.71.3/document.xsl"/>
	<xsl:include href="/versions/pc8080/1.71.3/components.xsl"/>
