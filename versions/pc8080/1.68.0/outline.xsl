...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/pc8080/1.68.0/common.xsl"/>
	<xsl:include href="/versions/pc8080/1.68.0/document.xsl"/>
	<xsl:include href="/versions/pc8080/1.68.0/components.xsl"/>
