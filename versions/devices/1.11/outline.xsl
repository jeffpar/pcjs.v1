...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="/versions/devices/1.11/common.xsl"/>
	<xsl:include href="/versions/devices/1.11/document.xsl"/>
	<xsl:include href="/versions/devices/1.11/components.xsl"/>
