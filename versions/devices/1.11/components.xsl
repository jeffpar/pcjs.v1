...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="APPCLASS">ti57</xsl:variable>
	<xsl:variable name="APPNAME">TI57</xsl:variable>
	<xsl:variable name="APPVERSION">1.11</xsl:variable>
	<xsl:variable name="SITEHOST">www.pcjs.org</xsl:variable>
	<xsl:variable name="BGNDCOLOR">#FAEBD7</xsl:variable>

	<xsl:template name="componentStyles">
		<link rel="stylesheet" type="text/css" href="/versions/devices/1.11/components.css"/>
	</xsl:template>
