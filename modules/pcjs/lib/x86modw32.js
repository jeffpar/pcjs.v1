...
X86ModW32.aOpModReg = [
    ...
    function opMod32RegWord00(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord01(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regECX));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord02(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEDX));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord04(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord08(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord09(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regECX));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord0A(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEDX));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord0C(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord10(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord11(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regECX));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord12(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEDX));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord14(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord18(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord19(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regECX));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord1A(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEDX));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord1C(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord20(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord21(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regECX));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBase;
    },
    /**
    ...
    function opMod32RegWord22(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEDX));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBase;
    },
    /**
    ...
    function opMod32RegWord24(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBase;
    },
    /**
    ...
    function opMod32RegWord28(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord29(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regECX));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord2A(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEDX));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord2C(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord30(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord31(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regECX));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord32(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEDX));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord34(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord38(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEAX));
    ...
    function opMod32RegWord39(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regECX));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord3A(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEDX));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord3C(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.getSIBAddr(0)));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord40(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord41(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord42(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord44(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord48(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord49(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord4A(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord4C(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord50(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord51(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord52(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord54(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord58(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord59(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord5A(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord5C(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord60(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWord61(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWord62(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWord64(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWord68(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord69(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord6A(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord6C(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord70(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord71(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord72(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord74(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord78(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEAX + this.getIPDisp()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord79(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regECX + this.getIPDisp()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord7A(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEDX + this.getIPDisp()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord7C(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.getSIBAddr(1) + this.getIPDisp()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord80(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord81(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord82(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord84(fn) {
        var w = fn.call(this, this.regEAX & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regEAX = (this.regEAX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiAL = this.backTrack.btiEALo; this.backTrack.btiAH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord88(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord89(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord8A(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord8C(fn) {
        var w = fn.call(this, this.regECX & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regECX = (this.regECX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiCL = this.backTrack.btiEALo; this.backTrack.btiCH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord90(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord91(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord92(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord94(fn) {
        var w = fn.call(this, this.regEDX & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regEDX = (this.regEDX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDL = this.backTrack.btiEALo; this.backTrack.btiDH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord98(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord99(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord9A(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWord9C(fn) {
        var w = fn.call(this, this.regEBX & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regEBX = (this.regEBX & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBL = this.backTrack.btiEALo; this.backTrack.btiBH = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordA0(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWordA1(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWordA2(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWordA4(fn) {
        var w = fn.call(this, this.getSP() & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.setSP((this.getSP() & ~this.maskData) | w);
        this.nStepCycles -= this.cycleCounts.nEACyclesBaseDisp;
    },
    /**
    ...
    function opMod32RegWordA8(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordA9(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordAA(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordAC(fn) {
        var w = fn.call(this, this.regEBP & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regEBP = (this.regEBP & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiBPLo = this.backTrack.btiEALo; this.backTrack.btiBPHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB0(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB1(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB2(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB4(fn) {
        var w = fn.call(this, this.regESI & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regESI = (this.regESI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiSILo = this.backTrack.btiEALo; this.backTrack.btiSIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB8(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEAX + this.getIPAddr()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordB9(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regECX + this.getIPAddr()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordBA(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.regEDX + this.getIPAddr()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
    ...
    function opMod32RegWordBC(fn) {
        var w = fn.call(this, this.regEDI & this.maskData, this.getEAWordData(this.getSIBAddr(2) + this.getIPAddr()));
        this.regEDI = (this.regEDI & ~this.maskData) | w;
        if (BACKTRACK) {
            this.backTrack.btiDILo = this.backTrack.btiEALo; this.backTrack.btiDIHi = this.backTrack.btiEAHi;
        }
...
X86ModW32.aOpModMem = [
    ...
    function opMod32MemWord00(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regEAX & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord01(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord02(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord04(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord08(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regECX & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord09(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord0A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord0C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord10(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regEDX & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord11(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord12(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord14(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord18(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regEBX & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord19(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord1A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord1C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord28(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regEBP & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord29(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord2A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord2C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord30(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regESI & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord31(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord32(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord34(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord38(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX), this.regEDI & this.maskData);
        if (BACKTRACK) {
    ...
    function opMod32MemWord39(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord3A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord3C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(0)), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord40(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord41(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord42(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord44(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord48(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord49(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord4A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord4C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord50(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord51(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord52(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord54(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord58(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord59(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord5A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord5C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord68(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord69(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord6A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord6C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord70(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord71(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord72(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord74(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord78(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPDisp()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord79(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPDisp()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord7A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPDisp()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord7C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(1) + this.getIPDisp()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord80(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord81(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord82(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord84(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regEAX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiAL; this.backTrack.btiEAHi = this.backTrack.btiAH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord88(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord89(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord8A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord8C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regECX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiCL; this.backTrack.btiEAHi = this.backTrack.btiCH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord90(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord91(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord92(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord94(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regEDX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDL; this.backTrack.btiEAHi = this.backTrack.btiDH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord98(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord99(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord9A(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWord9C(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regEBX & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBL; this.backTrack.btiEAHi = this.backTrack.btiBH;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordA8(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordA9(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordAA(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordAC(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regEBP & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiBPLo; this.backTrack.btiEAHi = this.backTrack.btiBPHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB0(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB1(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB2(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB4(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regESI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiSILo; this.backTrack.btiEAHi = this.backTrack.btiSIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB8(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEAX + this.getIPAddr()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordB9(fn) {
        var w = fn.call(this, this.modEAWordData(this.regECX + this.getIPAddr()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordBA(fn) {
        var w = fn.call(this, this.modEAWordData(this.regEDX + this.getIPAddr()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
    ...
    function opMod32MemWordBC(fn) {
        var w = fn.call(this, this.modEAWordData(this.getSIBAddr(2) + this.getIPAddr()), this.regEDI & this.maskData);
        if (BACKTRACK) {
            this.backTrack.btiEALo = this.backTrack.btiDILo; this.backTrack.btiEAHi = this.backTrack.btiDIHi;
        }
        this.setEAWord(w);
