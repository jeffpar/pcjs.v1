...
class Keyboard extends Component {
    ...
    onKeyChange(event, fDown)
    {
        ...
        if (keyCode == 229 && event.code) {
            ...
            this.printf(Messages.EVENT + Messages.KEY, "onKeyChange(%d): remapped using event code '%s'\n", keyCode, code);
        }
        ...
        this.printf(Messages.EVENT + Messages.KEY, "onKeyChange(%d): %b%s\n", keyCode, fDown, (fIgnore? ",ignore" : (fPass? "" : ",consume")));
        ...
        if (!fIgnore && (!this.fMobile || !fPass)) {
            if (fDown) {
                ...
                if (this.fDelayALT && (this.bitsState & Keyboard.STATE.ALTS)) {
                    ...
                    this.printf(Messages.EVENT, "onKeyChange(%d): simulating ALT down\n", simCodeAlt);
