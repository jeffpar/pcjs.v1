 ...
 */
function ComputerPDP11(parmsComputer, parmsMachine, fSuspended) {
...
Component.subclass(ComputerPDP11);
 ...
 * @return {string}
 */
ComputerPDP11.prototype.getMachineID = function()
{
 ...
 * @param {Object} [parmsMachine]
 */
ComputerPDP11.prototype.setMachineParms = function(parmsMachine)
{
    if (!parmsMachine) {
        var sParms;
 ...
 */
ComputerPDP11.prototype.getMachineParm = function(sParm, parmsComponent)
{
    /*
 ...
 * @return {string|null}
 */
ComputerPDP11.prototype.saveMachineParms = function()
{
 ...
 * @return {string}
 */
ComputerPDP11.prototype.getUserID = function()
{
    return this.sUserID || "";
};
 ...
 */
ComputerPDP11.prototype.doneLoad = function(sURL, sStateData, nErrorCode)
{
    if (!nErrorCode) {
 ...
 */
ComputerPDP11.prototype.wait = function(fn, parms)
{
    var computer = this;
    var aComponents = Component.getComponents(this.id);
 ...
 */
ComputerPDP11.prototype.validateState = function(stateComputer)
{
    var fValid = true;
 ...
 */
ComputerPDP11.prototype.powerOn = function(resume)
{
    if (resume === undefined) {
 ...
 */
ComputerPDP11.prototype.donePowerOn = function(aParms)
{
 ...
 * @param {State} stateComputer
 */
ComputerPDP11.prototype.powerReport = function(stateComputer)
{
 ...
 */
ComputerPDP11.prototype.powerOff = function(fSave, fShutdown)
{
    var data;
    var sState = "none";
 ...
 */
ComputerPDP11.prototype.start = function(ms, nCycles)
{
    var aComponents = Component.getComponents(this.id);
    for (var iComponent = 0; iComponent < aComponents.length; iComponent++) {
        var component = aComponents[iComponent];
 ...
 * @param {number} nCycles
 */
ComputerPDP11.prototype.stop = function(ms, nCycles)
{
    var aComponents = Component.getComponents(this.id);
    for (var iComponent = 0; iComponent < aComponents.length; iComponent++) {
        var component = aComponents[iComponent];
 ...
 * resetUserID()
 */
ComputerPDP11.prototype.resetUserID = function()
{
 ...
 */
ComputerPDP11.prototype.queryUserID = function(fPrompt)
{
 ...
 */
ComputerPDP11.prototype.verifyUserID = function(sUserID)
{
    this.sUserID = null;
 ...
 */
ComputerPDP11.prototype.getServerStatePath = function()
{
    var sStatePath = null;
    if (this.sUserID) {
        if (DEBUG && this.messageEnabled()) {
 ...
 */
ComputerPDP11.prototype.saveServerState = function(sUserID, sState)
{
    /*
 ...
 */
ComputerPDP11.prototype.storeServerState = function(sUserID, sState, fSync)
{
    if (DEBUG && this.messageEnabled()) {
 ...
 * @this {ComputerPDP11}
 */
ComputerPDP11.prototype.onReset = function()
{
    /*
 ...
 */
ComputerPDP11.prototype.getMachineComponent = function(sType, componentPrev)
{
