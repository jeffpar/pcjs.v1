 ...
 * @param {string} mode
 */
function DiskPDP11(controller, drive, mode)
{
    Component.call(this, "Disk", {'id': controller.idMachine + ".disk" + str.toHex(++DiskPDP11.nDisks, 4)}, DiskPDP11, MessagesPDP11.DISK);
 ...
 */
DiskPDP11.prototype.initBus = function(cmp, bus, cpu, dbg) {
    this.dbg = dbg;
};
 ...
 */
DiskPDP11.prototype.create = function(mode, nCylinders, nHeads, nSectors, cbSector)
{
    this.mode = mode;
 ...
 */
DiskPDP11.prototype.load = function(sDiskName, sDiskPath, file, fnNotify, controller)
{
 ...
 */
DiskPDP11.prototype.build = function(buffer, fModified)
{
    var disk;
 ...
 */
DiskPDP11.prototype.doneLoad = function(sURL, sDiskData, nErrorCode)
{
    var disk = null;
 ...
 * @return {string}
 */
DiskPDP11.prototype.getSectorString = function(sector, off, len)
{
    var s = "";
    while (len--) {
 ...
 * @return {Object}
 */
DiskPDP11.prototype.initSector = function(sector, iCylinder, iHead, iSector, cbSector, dwPattern)
{
    if (!sector) {
 ...
 */
DiskPDP11.prototype.info = function()
{
 ...
 */
DiskPDP11.prototype.seek = function(iCylinder, iHead, iSector, fWrite, done)
{
    var sector = null;
 ...
 * @param {number} off
 */
DiskPDP11.prototype.fill = function(sector, ab, off)
{
 ...
 */
DiskPDP11.prototype.toBytes = function(sector)
{
 ...
 */
DiskPDP11.prototype.read = function(sector, ibSector, fCompare)
{
    var b = -1;
    if (sector) {
 ...
 */
DiskPDP11.prototype.write = function(sector, ibSector, b)
{
 ...
 */
DiskPDP11.prototype.getSector = function(pba)
{
 ...
 * @return {number}
 */
DiskPDP11.prototype.getSectorData = function(sector, off, len)
{
    var dw = 0;
    var nShift = 0;
 ...
 * @return {string}
 */
DiskPDP11.prototype.encodeAsBase64 = function()
{
    /*
 ...
 */
DiskPDP11.prototype.save = function()
{
    var i = 0;
    var deltas = [];
 ...
 */
DiskPDP11.prototype.restore = function(deltas)
{
    /*
 ...
 */
DiskPDP11.prototype.toJSON = function()
{
 ...
 * @param {Object} sector
 */
DiskPDP11.prototype.deflateSector = function(sector)
{
    var adw = sector['data'];
    var cdw = adw.length;
 ...
 * @return {string}
 */
DiskPDP11.prototype.dumpSector = function(sector, pba, sDesc)
{
    var sDump = "";
    if (DEBUG && sector) {
