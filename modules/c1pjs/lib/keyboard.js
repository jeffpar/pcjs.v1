 ...
 * @this {C1PKeyboard}
 */
C1PKeyboard.prototype.reset = function()
{
 ...
 * @param {C1PCPU} cpu
 */
C1PKeyboard.prototype.setBuffer = function(abMemory, start, end, cpu)
{
    this.abMem = abMemory;
    this.offKbd = start;
 ...
 * @param {number} nModel
 */
C1PKeyboard.prototype.setModel = function(nModel)
{
    this.nModel = nModel;
    /*
 ...
 * @return {number}
 */
C1PKeyboard.prototype.calcReleaseDelay = function(fRepeat)
{
    /*
 ...
 * @return {boolean}
 *
C1PKeyboard.prototype.isShift = function(charCode)
{
 ...
 */
C1PKeyboard.prototype.autoClear = function(notCharCode)
{
 ...
 */
C1PKeyboard.prototype.injectKeys = function(sKeyCodes, msDelay)
{
 ...
 */
C1PKeyboard.prototype.injectKeysFromBuffer = function(msDelay)
{
 ...
 */
C1PKeyboard.prototype.keyEvent = function(event, fDown)
{
    var fPass;
 ...
 * when debugging.
 */
C1PKeyboard.prototype.keyPress = function(event)
{
    var fPass = true;
    /*
 ...
 */
C1PKeyboard.prototype.keyPressSimulate = function(charCode)
{
 ...
 * @return {boolean} true if successfully simulated, false if unrecognized/unsupported key
 */
C1PKeyboard.prototype.keyEventSimulate = function(charCode, fDown, simCode)
{
    var fSimulated = false;
    if (!fDown) {
 ...
 */
C1PKeyboard.prototype.getByte = function(addr, addrFrom)
{
    /*
 ...
 */
C1PKeyboard.prototype.setByte = function(addr, addrFrom)
{
 ...
 */
C1PKeyboard.prototype.updateMemory = function(fPropagate, addr, bWrite)
{
    /*
