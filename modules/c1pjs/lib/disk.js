 ...
 * @extends Component
 */
function C1PDiskController(parmsDC)
{
 ...
 */
C1PDiskController.prototype.reset = function(fPowerOn)
{
    this.resetRegs();
    this.iDriveSelect = -1;
    if (fPowerOn) {
 ...
 * @this {C1PDiskController}
 */
C1PDiskController.prototype.resetRegs = function()
{
    this.regDDA = {
 ...
 */
C1PDiskController.prototype.resetDrive = function(iDrive, iDriveType, nMaxTracks)
{
    this.aDrives[iDrive] = {
        iType: iDriveType,
        nTracks: nMaxTracks,
 ...
 * @param {C1PCPU} cpu
 */
C1PDiskController.prototype.setBuffer = function(abMemory, start, end, cpu)
{
    this.abMem = abMemory;
 ...
 */
C1PDiskController.prototype.loadDisk = function(sDiskName, sDiskData, nErrorCode)
{
    if (nErrorCode) {
 ...
 */
C1PDiskController.prototype.pushBCD = function(a, o, k)
{
    var n = o[k];
    if (n === undefined) {
 ...
 */
C1PDiskController.prototype.pushBin = function(a, o, k, cb)
{
    var n = o[k];
    if (n === undefined) {
 ...
 */
C1PDiskController.prototype.pushSig = function(a, o, k)
{
    var s = o[k];
    if (s === undefined) {
 ...
 */
C1PDiskController.prototype.getReg = function(port, fWrite)
{
    var reg;
    port &= 0x3F;
    /*
 ...
 */
C1PDiskController.prototype.getByte = function(addr, addrFrom)
{
    /*
 ...
 */
C1PDiskController.prototype.setByte = function(addr, addrFrom)
{
    /*
     * Don't trigger any further hardware emulation (beyond what we've already stored in memory) if
 ...
 * @param {number} bPDB
 */
C1PDiskController.prototype.setSelectedDrive = function(bPDA, bPDB)
{
    var iDriveSelect = -1;
 ...
 *
C1PDiskController.prototype.getSelectedDrive = function(fLoaded)
{
    var drive = null;
 ...
 * @this {C1PDiskController}
 */
C1PDiskController.prototype.startDriveData = function()
{
    if (this.iDriveSelect >= 0) {
 ...
 * @this {C1PDiskController}
 */
C1PDiskController.prototype.stopDriveData = function()
{
    if (this.iDriveSelect >= 0) {
 ...
 */
C1PDiskController.prototype.advanceDriveData = function()
{
    var b = null;
    if (this.iDriveSelect >= 0) {
 ...
 */
C1PDiskController.prototype.updatePDA = function(bPDA)
{
    if (bPDA === undefined)
 ...
 */
C1PDiskController.prototype.updatePDB = function(bPDB)
{
    if (bPDB === undefined)
 ...
 */
C1PDiskController.prototype.updateSTAT = function(bSTAT)
{
    if (bSTAT === undefined)
 ...
 * @param {Object} reg
 */
C1PDiskController.prototype.writePort = function(port, reg)
{
