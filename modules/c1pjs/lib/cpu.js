 ...
 * @param {number} end
 */
C1PCPU.prototype.setBuffer = function(abMemory, start, end)
{
    this.abMem = abMemory;
    this.offMem = start;
 ...
 */
C1PCPU.prototype.addReadNotify = function(start, end, component, fn)
{
 ...
 */
C1PCPU.prototype.checkReadNotify = function(addrRead, addrFrom)
{
 ...
 */
C1PCPU.prototype.removeReadNotify = function(start, end, component, fn)
{
 ...
 * @param {function(number,number)} fn is called with the EA and PC values at the time of the write
 */
C1PCPU.prototype.addWriteNotify = function(start, end, component, fn)
{
 ...
 * so all handlers should be prepared for that as well.
 */
C1PCPU.prototype.checkWriteNotify = function(addrWrite, addrFrom)
{
 ...
 * @return {boolean} true if remove was successful, false if the handler was not found
 */
C1PCPU.prototype.removeWriteNotify = function(start, end, component, fn)
{
 ...
 */
C1PCPU.prototype.findNotify = function(aNotify, start, end, component, fn)
{
 ...
 */
C1PCPU.prototype.removeNotify = function(aNotify, start, end, component, fn)
{
    var aBounds = [];
 ...
 */
C1PCPU.prototype.setSpeed = function(speed, fOnClick)
{
    if (speed !== undefined) {
        this.speed = speed;
 ...
 */
C1PCPU.prototype.calcSpeed = function(nCycles, msElapsed)
{
    if (msElapsed) {
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.displayVideo = function()
{
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.setFocus = function()
{
    // Nothing to do until setPower() installs a replacement function
};
 ...
 * @param {number} [len]
 */
C1PCPU.prototype.displayReg = function(sReg, vReg, len)
{
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.displayStatus = function()
{
 ...
 */
C1PCPU.prototype.calcCycles = function(fRecalc)
{
    /*
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.calcStartTime = function()
{
 ...
 * @return {number}
 */
C1PCPU.prototype.calcRemainingTime = function()
{
 ...
 */
C1PCPU.prototype.step = function(nMinCycles)
{
    /*
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.yieldCPU = function()
{
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.halt = function()
{
    this.isBusy(true);
    this.nBurstCycles -= this.nStepCycles;
    this.nStepCycles = 0;
 ...
 */
C1PCPU.prototype.update = function()
{
    this.displayVideo();
    this.displayStatus();
};
 ...
 * performance reasons.
 */
C1PCPU.prototype.getByte = function(addr)
{
 ...
 * @return {number}
 */
C1PCPU.prototype.getWord = function(addr)
{
    Component.assert((addr >= this.offMem && addr < this.offLimit), "invalid address: " + str.toHexWord(addr));
 ...
 * @param {number} b
 */
C1PCPU.prototype.setByte = function(addr, b)
{
    Component.assert((addr >= this.offMem && addr < this.offLimit), "invalid address: " + str.toHexWord(addr));
    Component.assert(!(b & ~0xff), "invalid byte (" + b + ") at address " + str.toHexWord(addr));
    this.abMem[addr] = b;
 ...
 * @return {number}
 */
C1PCPU.prototype.getRegP = function()
{
    /*
     *  // C = LAZY_C;
 ...
 * Clear the C flag
 */
C1PCPU.prototype.clearC = function()
{
    this.regRC = 0x00;
};
 ...
 * Set the C flag
 */
C1PCPU.prototype.setC = function()
{
    this.regRC = 0x100;
};
 ...
 * Clear the N bit
 */
C1PCPU.prototype.clearN = function()
{
    this.regRN = 0x00;
};
 ...
 * Set the N bit
 */
C1PCPU.prototype.setN = function()
{
    this.regRN = 0x80;
};
 ...
 * Clear the V bit
 */
C1PCPU.prototype.clearV = function()
{
 ...
 * Set the V bit
 */
C1PCPU.prototype.setV = function()
{
 ...
 * Clear the Z bit
 */
C1PCPU.prototype.clearZ = function()
{
    this.regRZ = 0x01;
};
 ...
 * Set the Z bit
 */
C1PCPU.prototype.setZ = function()
{
    this.regRZ = 0x00;
};
 ...
 */
C1PCPU.prototype.setBCD = function()
{
    this.regP |= 0x08;
 ...
 */
C1PCPU.prototype.clearBCD = function()
{
    this.regP &= ~0x08;
 ...
 */
C1PCPU.prototype.addBCD = function(reg, mem)
{
 ...
 * Refer to http://homepage.cs.uiowa.edu/~jones/bcd/bcd.html for optimization tips.
 */
C1PCPU.prototype.subBCD = function(reg, mem)
{
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.clearRegs = function()
{
    this.regA = 0;
    this.regX = 0;
    this.regY = 0;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBRK = function()
{   // opcode 0x00
    // PC++;
    this.regPC++;
    // STACK(S--) = PCH;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAindx = function()
{   // opcode 0x01
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAzp = function()
{   // opcode 0x05
    // EA = BYTE(PC++);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opASLzp = function()
{   // opcode 0x06
    // EA = BYTE(PC++);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opPHP = function()
{   // opcode 0x08
    this.regP = this.getRegP();
    // STACK(S--) = P;
    this.abMem[this.regS--] = this.regP;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAimm = function()
{   // opcode 0x09
    // EA = PC++;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opASLacc = function()
{   // opcode 0x0a
    // RC = A << 1;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAabs = function()
{   // opcode 0x0d
    // EA = WORD(PC); PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opASLabs = function()
{   // opcode 0x0e
    // EA = WORD(PC); PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBPL = function()
{   // opcode 0x10
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAindy = function()
{   // opcode 0x11
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAzpx = function()
{   // opcode 0x15
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = A | ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opASLzpx = function()
{   // opcode 0x16
    // EA = (BYTE(PC++)+X) & 0xff;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCLC = function()
{   // opcode 0x18
    // SET_LAZY_C(0);
    this.regRC = 0x00;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAabsy = function()
{   // opcode 0x19
    // EA = WORD(PC)+Y; PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opORAabsx = function()
{   // opcode 0x1d
    // EA = WORD(PC)+X; PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opASLabsx = function()
{   // opcode 0x1e
    // EA = WORD(PC)+X; PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opJSRabs = function()
{   // opcode 0x20
    // EA = PC; PC += 1;
    this.regEA = this.regPC++;
    // STACK(S--) = PCH;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDindx = function()
{   // opcode 0x21
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBITzp = function()
{   // opcode 0x24
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // SET_LAZY_Z((A & ML) == 0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDzp = function()
{   // opcode 0x25
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opROLzp = function()
{   // opcode 0x26
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opPLP = function()
{   // opcode 0x28
    // P = STACK(++S);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDimm = function()
{   // opcode 0x29
    // EA = PC++;
    this.regEA = this.regPC++;
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opROLacc = function()
{   // opcode 0x2a
    // RCL =  A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBITabs = function()
{   // opcode 0x2c
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // SET_LAZY_Z((A & ML) == 0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDabs = function()
{   // opcode 0x2d
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opROLabs = function()
{   // opcode 0x2e
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBMI = function()
{   // opcode 0x30
    // PC = PC + (LAZY_N != 0? SBYTE(PC) : 0) + 1;
    this.regPC += ((this.regRN & 0x80)? (this.nStepCycles--,((this.abMem[this.regPC] << 24) >> 24)) : 0) + 1;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDindy = function()
{   // opcode 0x31
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDzpx = function()
{   // opcode 0x35
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opROLzpx = function()
{   // opcode 0x36
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSEC = function()
{   // opcode 0x38
    // SET_LAZY_C(1);
    this.regRC = 0x0100;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDabsy = function()
{   // opcode 0x39
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opANDabsx = function()
{   // opcode 0x3d
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // A = A & ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opROLabsx = function()
{   // opcode 0x3e
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRTI = function()
{   // opcode 0x40
    // P = STACK(++S);
    this.regS = ((this.regS+1) & 0xff) | 0x100;
    this.regP = this.abMem[this.regS];
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORindx = function()
{   // opcode 0x41
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORzp = function()
{   // opcode 0x45
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // A = A ^ ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLSRzp = function()
{   // opcode 0x46
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // SET_LAZY_C(ML0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opPHA = function()
{   // opcode 0x48
    // STACK(S--) = A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORimm = function()
{   // opcode 0x49
    // EA = PC++;
    this.regEA = this.regPC++;
    // A = A ^ ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLSRacc = function()
{   // opcode 0x4a
    // SET_LAZY_C( A0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opJMPimm16 = function()
{   // opcode 0x4c
    // EA = PC;
    this.regEA = this.regPC;
    // PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORabs = function()
{   // opcode 0x4d
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // A = A ^ ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLSRabs = function()
{   // opcode 0x4e
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // SET_LAZY_C(ML0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBVC = function()
{   // opcode 0x50
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORindy = function()
{   // opcode 0x51
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = this.abMem[this.regPC++];
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORzpx = function()
{   // opcode 0x55
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = A ^ ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLSRzpx = function()
{   // opcode 0x56
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // SET_LAZY_C(ML0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCLI = function()
{   // opcode 0x58
    // I = 0;
    this.regP &= 0xfb;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORabsy = function()
{   // opcode 0x59
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // A = A ^ ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opEORabsx = function()
{   // opcode 0x5d
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // A = A ^ ML; SET_LAZY_NZ(A)
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLSRabsx = function()
{   // opcode 0x5e
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // SET_LAZY_C(ML0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRTS = function()
{   // opcode 0x60
    // PCL = STACK(++S);
    // PCH = STACK(++S);
    // PC++;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCindx = function()
{   // opcode 0x61
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCindxBCD = function()
{   // opcode 0x61
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCzp = function()
{   // opcode 0x65
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCzpBCD = function()
{   // opcode 0x65
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRORzp = function()
{   // opcode 0x66
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opPLA = function()
{   // opcode 0x68
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCimm = function()
{   // opcode 0x69
    // EA = PC++;
    this.regEA = this.regPC++;
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCimmBCD = function()
{   // opcode 0x69
    // EA = PC++;
    this.regEA = this.regPC++;
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRORacc = function()
{   // opcode 0x6a
    // RCL =  A;
    this.regRC = ((this.regRC & 0xff00) | this.regA);
    // RCH1 = RCL0;
 ...
 */
C1PCPU.prototype.opJMPabs16 = function()
{   // opcode 0x6c
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // PC = M;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabs = function()
{   // opcode 0x6d
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabsBCD = function()
{   // opcode 0x6d
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRORabs = function()
{   // opcode 0x6e
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBVS = function()
{   // opcode 0x70
    // PC = PC + (LAZY_V != 0? SBYTE(PC) : 0) + 1;
    this.regPC += (((((this.regRV & 0xff) ^ this.regRU) ^ (this.regRV >> 1)) & 0x80)? (this.nStepCycles--,((this.abMem[this.regPC] << 24) >> 24)) : 0) + 1;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCindy = function()
{   // opcode 0x71
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCindyBCD = function()
{   // opcode 0x71
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCzpx = function()
{   // opcode 0x75
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCzpxBCD = function()
{   // opcode 0x75
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRORzpx = function()
{   // opcode 0x76
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSEI = function()
{   // opcode 0x78
    // I = 1;
    this.regP |= 0x04;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabsy = function()
{   // opcode 0x79
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabsyBCD = function()
{   // opcode 0x79
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabsx = function()
{   // opcode 0x7d
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // RC = (A + ML + LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opADCabsxBCD = function()
{   // opcode 0x7d
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // A = this.addBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opRORabsx = function()
{   // opcode 0x7e
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // RCL = ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAindx = function()
{   // opcode 0x81
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEAWrite = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTYzp = function()
{   // opcode 0x84
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // ML = Y;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAzp = function()
{   // opcode 0x85
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // ML = A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTXzp = function()
{   // opcode 0x86
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // ML = X;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDEY = function()
{   // opcode 0x88
    // Y = ((Y - 1) & 0xff);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTXA = function()
{   // opcode 0x8a
    // A = X; SET_LAZY_NZ(X);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTYabs = function()
{   // opcode 0x8c
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // ML = Y;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAabs = function()
{   // opcode 0x8d
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // ML = A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTXabs = function()
{   // opcode 0x8e
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // ML = X;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBCC = function()
{   // opcode 0x90
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAindy = function()
{   // opcode 0x91
    // EA = WORD(BYTE(PC++))+Y;
    this.regEAWrite = (this.abMem[this.regPC++]);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTYzpx = function()
{   // opcode 0x94
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // ML = Y;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAzpx = function()
{   // opcode 0x95
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // ML = A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTXzpy = function()
{   // opcode 0x96
    // EA = (BYTE(PC++)+Y) & 0xff;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTYA = function()
{   // opcode 0x98
    // A = Y; SET_LAZY_NZ(Y);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAabsy = function()
{   // opcode 0x99
    // EA = WORD(PC)+Y; PC += 2;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTXS = function()
{   // opcode 0x9a
    // S = X;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSTAabsx = function()
{   // opcode 0x9d
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // ML = A;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDYimm = function()
{   // opcode 0xa0
    // EA = PC++;
    this.regEA = this.regPC++;
    // Y = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAindx = function()
{   // opcode 0xa1
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDXimm = function()
{   // opcode 0xa2
    // EA = PC++;
    this.regEA = this.regPC++;
    // X = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDYzp = function()
{   // opcode 0xa4
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // Y = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAzp = function()
{   // opcode 0xa5
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // A = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDXzp = function()
{   // opcode 0xa6
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // X = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTAY = function()
{   // opcode 0xa8
    // Y = A; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAimm = function()
{   // opcode 0xa9
    // EA = PC++;
    this.regEA = this.regPC++;
    // A = ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTAX = function()
{   // opcode 0xaa
    // X = A; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDYabs = function()
{   // opcode 0xac
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // Y = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAabs = function()
{   // opcode 0xad
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // A = ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDXabs = function()
{   // opcode 0xae
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // X = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBCS = function()
{   // opcode 0xb0
    // PC = PC + (LAZY_C != 0? SBYTE(PC) : 0) + 1;
    this.regPC += ((this.regRC & 0x0100)? (this.nStepCycles--,((this.abMem[this.regPC] << 24) >> 24)) : 0) + 1;
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAindy = function()
{   // opcode 0xb1
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDYzpx = function()
{   // opcode 0xb4
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // Y = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAzpx = function()
{   // opcode 0xb5
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDXzpy = function()
{   // opcode 0xb6
    // EA = (BYTE(PC++)+Y) & 0xff;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCLV = function()
{   // opcode 0xb8
    // SET_LAZY_V(0);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAabsy = function()
{   // opcode 0xb9
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // A = ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opTSX = function()
{   // opcode 0xba
    // X = S; SET_LAZY_NZ(S);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDYabsx = function()
{   // opcode 0xbc
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // Y = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDAabsx = function()
{   // opcode 0xbd
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // A = ML; SET_LAZY_NZ(A);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opLDXabsy = function()
{   // opcode 0xbe
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // X = ML; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPYimm = function()
{   // opcode 0xc0
    // EA = PC++;
    this.regEA = this.regPC++;
    // RC = Y - ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPindx = function()
{   // opcode 0xc1
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPYzp = function()
{   // opcode 0xc4
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // RC = Y - ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPzp = function()
{   // opcode 0xc5
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDECzp = function()
{   // opcode 0xc6
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINY = function()
{   // opcode 0xc8
    // Y = ((Y + 1) & 0xff);
    this.regY = ((this.regY + 1) & 0xff);
    // SET_LAZY_NZ(Y);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPimm = function()
{   // opcode 0xc9
    // EA = PC++;
    this.regEA = this.regPC++;
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDEX = function()
{   // opcode 0xca
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPYabs = function()
{   // opcode 0xcc
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPabs = function()
{   // opcode 0xcd
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDECabs = function()
{   // opcode 0xce
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // ML = ML - 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBNE = function()
{   // opcode 0xd0
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPindy = function()
{   // opcode 0xd1
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPzpx = function()
{   // opcode 0xd5
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDECzpx = function()
{   // opcode 0xd6
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // ML = ML - 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCLD = function()
{   // opcode 0xd8
    // D = 0;
    this.clearBCD();
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPabsy = function()
{   // opcode 0xd9
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCMPabsx = function()
{   // opcode 0xdd
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // RC = A - ML; SET_LAZY_NZ(RC);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opDECabsx = function()
{   // opcode 0xde
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // ML = ML - 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPXimm = function()
{   // opcode 0xe0
    // EA = PC++;
    this.regEA = this.regPC++;
    // RC = X - ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCindx = function()
{   // opcode 0xe1
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCindxBCD = function()
{   // opcode 0xe1
    // EA = WORD((BYTE(PC++)+X) & 0xff);
    this.regEA = ((this.abMem[this.regPC++]) + this.regX) & 0xff;
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPXzp = function()
{   // opcode 0xe4
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // RC = X - ML;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCzp = function()
{   // opcode 0xe5
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCzpBCD = function()
{   // opcode 0xe5
    // EA = BYTE(PC++);
    this.regEA = this.abMem[this.regPC++];
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINCzp = function()
{   // opcode 0xe6
    // EA = BYTE(PC++);
    this.regEAWrite = this.abMem[this.regPC++];
    // ML = ML + 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINX = function()
{   // opcode 0xe8
    // X = ((X + 1) & 0xff);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCimm = function()
{   // opcode 0xe9
    // EA = PC++;
    this.regEA = this.regPC++;
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCimmBCD = function()
{   // opcode 0xe9
    // EA = PC++;
    this.regEA = this.regPC++;
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opNOP = function()
{   // opcode 0xea
    //
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opCPXabs = function()
{   // opcode 0xec
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabs = function()
{   // opcode 0xed
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabsBCD = function()
{   // opcode 0xed
    // EA = WORD(PC); PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINCabs = function()
{   // opcode 0xee
    // EA = WORD(PC); PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8));
    // ML = ML + 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opBEQ = function()
{   // opcode 0xf0
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCindy = function()
{   // opcode 0xf1
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCindyBCD = function()
{   // opcode 0xf1
    // EA = WORD(BYTE(PC++))+Y;
    this.regEA = (this.abMem[this.regPC++]);
    this.regEA = (this.abMem[this.regEA] | (this.abMem[this.regEA+1] << 8)) + this.regY;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCzpx = function()
{   // opcode 0xf5
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCzpxBCD = function()
{   // opcode 0xf5
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEA = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINCzpx = function()
{   // opcode 0xf6
    // EA = (BYTE(PC++)+X) & 0xff;
    this.regEAWrite = (this.abMem[this.regPC++]+this.regX) & 0xff;
    // ML = ML + 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSED = function()
{   // opcode 0xf8
    // D = 1;
    this.setBCD();
};
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabsy = function()
{   // opcode 0xf9
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabsyBCD = function()
{   // opcode 0xf9
    // EA = WORD(PC)+Y; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regY;
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabsx = function()
{   // opcode 0xfd
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // RC = (A - ML - !LAZY_C);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSBCabsxBCD = function()
{   // opcode 0xfd
    // EA = WORD(PC)+X; PC += 2;
    this.regEA = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // A = this.subBCD(A,ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opINCabsx = function()
{   // opcode 0xfe
    // EA = WORD(PC)+X; PC += 2;
    this.regEAWrite = (this.abMem[this.regPC++] | (this.abMem[this.regPC++] << 8)) + this.regX;
    // ML = ML + 1; SET_LAZY_NZ(ML);
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opSim = function()
{
    var addr;
 ...
 * @this {C1PCPU}
 */
C1PCPU.prototype.opUndefined = function()
{
