...
[DAKAA.MAC](DAKAA.MAC) [[original file](http://pdp-10.trailing-edge.com/klad_sources/01/klad.sources/dakaam.mac.html)]
...
will automatically read the [TEST.MAC](TEST.MAC) source file (a slightly modified copy of [DAKAA.MAC](DAKAA.MAC)), assemble it,
and then load the binary output at the specified address.
...
To view the contents of **DAKAA.SEQ** (a combination of [DAKAA.TXT](#dakaatxt), a MACRO-10 assembly listing, and run data),
click [here](DAKAA.SEQ.txt).
